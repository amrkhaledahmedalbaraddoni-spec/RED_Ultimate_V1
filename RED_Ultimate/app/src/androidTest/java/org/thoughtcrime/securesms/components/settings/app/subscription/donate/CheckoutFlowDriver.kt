...
import com.red.sovereign.components.settings.app.subscription.donate.gateway.GatewaySelectorTestTags
import com.red.sovereign.components.settings.app.subscription.donate.paypal.PayPalConfirmationDialogFragment
import com.red.sovereign.components.settings.app.subscription.donate.paypal.PayPalConfirmationResult
import com.red.sovereign.components.settings.app.subscription.donate.stripe.Stripe3DSDialogFragment
...
import com.red.sovereign.testing.endpoints.StripeResponses
...
class CheckoutFlowDriver(
  ...
  companion object {
    ...
    private const val TEST_EMAIL = "test@red.local"
  ...
  private fun proceedToGateway() {
    scrollToDescendant(R.id.recycler, withText(R.string.DonateToREDFragment__continue), scheduler)
    onView(withText(R.string.DonateToREDFragment__continue)).perform(ViewActions.click())
    scheduler.triggerActions()
  }

  /**
   * Fills the [com.red.sovereign.components.settings.app.subscription.donate.card.CreditCardFragment]
