...
/**
 * The instrumentation app stubs [com.red.sovereign.ApplicationContext.beginJobLoop] to a no-op, so enqueued
...
fun startJobLoopForTests() {
  ...
  (AppDependencies.application as REDInstrumentationApplicationContext).beginJobLoopForTests()
}
