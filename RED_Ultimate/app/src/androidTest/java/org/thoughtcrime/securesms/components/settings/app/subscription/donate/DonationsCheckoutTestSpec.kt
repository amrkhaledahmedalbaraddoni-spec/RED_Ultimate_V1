...
import com.red.sovereign.testing.endpoints.DonationResponses
import com.red.sovereign.testing.endpoints.EndpointResponse
import com.red.sovereign.testing.endpoints.MockEndpoints
import com.red.sovereign.testing.endpoints.StripeResponses
import com.red.sovereign.testing.endpoints.failure
import com.red.sovereign.testing.endpoints.ok
import com.red.sovereign.testing.endpoints.registerPayPalHappyPath
 ...
 * the shared responder (overriding the [com.red.sovereign.testing.InAppPaymentsRule]
...
data class WorldState(
  ...
  fun apply() {
    ...
    REDStore.inAppPayments.setOneTimeCurrency(currency)
    REDStore.inAppPayments.setRecurringDonationCurrency(currency)
    ...
    // RED-service PayPal endpoints (harmless for non-PayPal specs; distinct paths).
...
sealed interface ExpectedOutcome {
  ...
  /**
   * Payment setup succeeded and the payment moved past [com.red.sovereign.database.InAppPaymentTable.State.CREATED]
