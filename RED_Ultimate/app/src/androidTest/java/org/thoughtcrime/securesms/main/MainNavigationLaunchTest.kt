...
import com.red.sovereign.conversation.v2.ConversationFragment
...
class MainNavigationLaunchTest {
  ...
  fun coldLaunch_deepLinkIntent_reachesChatsList() {
    val intent = deepLinkIntent(Uri.parse("https://red.local/test-not-a-real-deeplink"))
    launchSync(intent).use { launched ->
      val recorder = launched.recorder
  ...
  /**
   * Mirrors [com.red.sovereign.sharing.v2.ShareActivity.openConversation]. We
  ...
  /**
   * Mirrors the image-share path through [com.red.sovereign.sharing.v2.ShareActivity.openConversation]:
  ...
  /**
   * Mirrors [com.red.sovereign.deeplinks.DeepLinkEntryActivity]: bare clearTop
