...
class SafetyNumberBottomSheetRepositoryTest {
  ...
  fun givenIHaveADistributionListDestination_whenIGetBuckets_thenIOnlyHaveDistributionListDestinationWithCorrespondingMembers() {
    ...
    val distributionList = REDDatabase.distributionLists.createList("ListA", distributionListMembers)!!
    val destinationKey = ContactSearchKey.RecipientSearchKey(REDDatabase.distributionLists.getRecipientId(distributionList)!!, true)
