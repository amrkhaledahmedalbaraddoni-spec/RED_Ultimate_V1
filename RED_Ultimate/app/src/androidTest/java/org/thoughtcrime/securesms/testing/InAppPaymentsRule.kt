...
import com.red.sovereign.testing.endpoints.delete
import com.red.sovereign.testing.endpoints.get
import com.red.sovereign.testing.endpoints.ok
import com.red.sovereign.testing.endpoints.post
import com.red.sovereign.testing.endpoints.put
import org.whispersystems.signalservice.internal.push.WhoAmIResponse

/**
 * Sets up common infrastructure for on-device InAppPayment testing.
 *
 * The RED-service edge is driven through the shared [MockEndpoints.responder] (the real
...
class InAppPaymentsRule : ExternalResource() {
  ...
  /**
   * Default happy-path responses for the RED donations endpoints. Registered generic-to-specific
