...
/**
 * A JUnit rule that retries tests annotated with [REDFlakyTest] before considering them to be a failure.
 * As the name implies, this is useful for known-flaky tests.
 */
class REDFlakyTestRule : TestRule {
  override fun apply(base: Statement, description: Description): Statement {
    val flakyAnnotation = description.getAnnotation(REDFlakyTest::class.java)
