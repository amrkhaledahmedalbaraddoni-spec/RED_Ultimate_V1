...
/**
 * Custom runner that replaces application with [REDInstrumentationApplicationContext].
 *
 ...
 */
@Suppress("unused")
class REDTestRunner : AndroidJUnitRunner() {
  ...
  override fun newApplication(cl: ClassLoader?, className: String?, context: Context?): Application {
    return super.newApplication(cl, REDInstrumentationApplicationContext::class.java.name, context)
  }
