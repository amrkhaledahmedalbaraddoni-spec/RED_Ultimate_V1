package com.red.sovereign.absbackup
...
import com.red.sovereign.absbackup.backupables.SvrAuthTokens
 ...
 */
class REDBackupAgent : BackupAgent() {
  ...
  companion object {
    private val TAG = Log.tag(REDBackupAgent::class)
  }
}
