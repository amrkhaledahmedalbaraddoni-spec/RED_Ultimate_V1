...
import com.red.sovereign.apkupdate.ApkUpdateNotifications.FailureReason
  ...
  override fun onReceive(context: Context, intent: Intent?) {
    ...
    when (statusCode) {
      PackageInstaller.STATUS_SUCCESS -> {
        if (REDStore.apkUpdate.lastApkUploadTime != REDStore.apkUpdate.pendingApkUploadTime) {
          Log.i(TAG, "Update installed successfully! Updating our lastApkUploadTime to ${REDStore.apkUpdate.pendingApkUploadTime}")
          REDStore.apkUpdate.lastApkUploadTime = REDStore.apkUpdate.pendingApkUploadTime
