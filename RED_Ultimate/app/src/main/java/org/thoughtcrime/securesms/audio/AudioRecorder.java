...
import com.red.sovereign.notifications.v2.InChatNotificationSoundSuppressor;
...
public class AudioRecorder {
  ...
  private static final ExecutorService executor = REDExecutors.newCachedSingleThreadExecutor("signal-AudioRecorder", ThreadUtil.PRIORITY_UI_BLOCKING_THREAD);
