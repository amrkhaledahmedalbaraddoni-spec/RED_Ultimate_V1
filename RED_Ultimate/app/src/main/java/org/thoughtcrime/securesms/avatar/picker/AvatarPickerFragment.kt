...
import com.red.sovereign.avatar.photo.PhotoEditorActivity
import com.red.sovereign.avatar.photo.PhotoEditorFragment
import com.red.sovereign.avatar.text.TextAvatarCreationFragment
import com.red.sovereign.avatar.vector.VectorAvatarCreationFragment
import com.red.sovereign.components.ButtonStripItemView
import com.red.sovereign.components.recyclerview.GridDividerDecoration
import com.red.sovereign.mediasend.AvatarSelectionActivity
...
class AvatarPickerFragment : Fragment(R.layout.avatar_picker_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_SELECT_AVATAR = "com.red.sovereign.avatar.picker.SELECT_AVATAR"
    const val SELECT_AVATAR_MEDIA = "com.red.sovereign.avatar.picker.SELECT_AVATAR_MEDIA"
    const val SELECT_AVATAR_CLEAR = "com.red.sovereign.avatar.picker.SELECT_AVATAR_CLEAR"
