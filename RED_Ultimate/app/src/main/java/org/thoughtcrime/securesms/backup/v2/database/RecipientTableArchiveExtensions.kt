...
import com.red.sovereign.backup.v2.exporters.ContactArchiveExporter
import com.red.sovereign.backup.v2.exporters.GroupArchiveExporter
...
fun RecipientTable.restoreReleaseNotes(): RecipientId {
  ...
  setProfileName(releaseChannelId, ProfileName.asGiven("RED"))
