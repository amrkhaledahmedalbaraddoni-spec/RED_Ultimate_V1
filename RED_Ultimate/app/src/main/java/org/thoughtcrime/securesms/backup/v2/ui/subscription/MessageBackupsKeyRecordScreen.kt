...
import com.red.sovereign.backup.v2.ui.warning.ClipStage
import com.red.sovereign.backup.v2.ui.warning.RecoveryKeyWarningSheetContent
import com.red.sovereign.backup.v2.ui.warning.RecoveryKeyWarningSheetEvent
...
import com.red.sovereign.fonts.MonoTypeface
import com.red.sovereign.keyvalue.REDStore
import com.red.sovereign.util.CommunicationActions
import com.red.sovereign.util.storage.AndroidCredentialRepository
import com.red.sovereign.util.storage.CredentialManagerError
import com.red.sovereign.util.storage.CredentialManagerResult
...
fun MessageBackupsKeyRecordScreen(
  ...
  MessageBackupsKeyRecordScreen(
    ...
    notifyKeyIsSameAsOnDeviceBackupKey = REDStore.backup.newLocalBackupsEnabled
  )
}
...
fun MessageBackupsKeyRecordScreen(
  ...
  if (displayConfirmKey) {
    ...
    ModalBottomSheet(
      sheetState = rememberModalBottomSheetState(skipPartiallyExpanded = true),
      containerColor = REDTheme.colors.colorSurface1,
              ...
              if (isCollapsed) {
                Box(
                  ...
                  modifier = Modifier.background(
                    color = REDTheme.colors.colorSurface1,
