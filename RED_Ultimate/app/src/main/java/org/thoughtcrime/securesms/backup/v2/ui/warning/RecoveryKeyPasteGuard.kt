 ...
 * keyboard hides (e.g. [com.red.sovereign.components.KeyboardEntryDialogFragment]) can use
...
fun ComposeText.guardAgainstRecoveryKeyPaste(
  ...
  setOnPasteListener { pasteText ->
    if (RecoveryKeyDetector.containsRecoveryKey(pasteText?.toString(), REDStore.account.accountEntropyPoolOrNull)) {
