...
fun FilePointer?.toLocalAttachment(
  ...
  return when (attachmentType) {
    ...
    AttachmentType.TRANSIT -> {
      val signalAttachmentPointer = REDServiceAttachmentPointer(
        cdnNumber = locatorInfo.transitCdnNumber ?: Cdn.CDN_0.cdnNumber,
        remoteId = REDServiceAttachmentRemoteId.from(locatorInfo.transitCdnKey!!, locatorInfo.transitCdnNumber ?: Cdn.CDN_0.cdnNumber),
        contentType = contentType,
        key = locatorInfo.key.toByteArray(),
