...
package com.red.sovereign.backup.v2.util
...
import com.red.sovereign.wallpaper.GradientChatWallpaper
import com.red.sovereign.wallpaper.SingleColorChatWallpaper
...
fun ChatStyle.toLocal(importState: ImportState): ChatColors? {
  ...
  if (this.customColorId != null) {
    return importState.remoteToLocalColorId[this.customColorId]?.let { localId ->
      ...
      return REDDatabase.chatColors.getById(colorId)
    }
  }
...
private fun Wallpaper.File.toFilePointer(db: REDDatabase, backupMode: BackupMode): FilePointer? {
