...
import com.red.sovereign.badges.models.Badge.Category.Companion.fromCode
...
object Badges {
  ...
  private fun getBestBadgeImageUriForDevice(serviceBadge: REDServiceProfile.Badge): Pair<Uri, String> {
  ...
  @JvmStatic
  fun fromServiceBadge(serviceBadge: REDServiceProfile.Badge): Badge {
