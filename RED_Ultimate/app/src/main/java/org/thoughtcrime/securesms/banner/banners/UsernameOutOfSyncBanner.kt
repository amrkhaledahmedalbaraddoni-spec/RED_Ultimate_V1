...
import com.red.sovereign.keyvalue.AccountValues.UsernameSyncState
...
class UsernameOutOfSyncBanner(private val onActionClick: (UsernameSyncState) -> Unit) : Banner<UsernameSyncState>() {
  ...
  override val enabled: Boolean
    get() {
      ...
      return when (REDStore.account.usernameSyncState) {
  ...
  override val dataFlow: Flow<UsernameSyncState>
    get() = flowOf(REDStore.account.usernameSyncState)
