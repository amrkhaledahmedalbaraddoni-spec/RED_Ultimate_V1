...
package com.red.sovereign.billing.upgrade
...
import com.red.sovereign.backup.v2.ui.subscription.MessageBackupsFlowViewModel
import com.red.sovereign.backup.v2.ui.subscription.MessageBackupsStage
...
abstract class UpgradeToPaidTierBottomSheet : ComposeBottomSheetDialogFragment(), InAppPaymentCheckoutDelegate.ErrorHandlerCallback {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    viewLifecycleOwner.lifecycleScope.launch(REDDispatchers.Main) {
