...
import com.red.sovereign.calls.YouAreAlreadyInACallSnackbar.YouAreAlreadyInACallSnackbar
import com.red.sovereign.calls.links.CallLinks
import com.red.sovereign.calls.links.EditCallLinkNameDialogFragment
import com.red.sovereign.calls.links.REDCallRow
...
class CreateCallLinkBottomSheetDialogFragment : ComposeBottomSheetDialogFragment() {
  ...
  override fun SheetContent() {
    ...
    CreateCallLinkBottomSheetContent(
      ...
      onShareViaREDClicked = this@CreateCallLinkBottomSheetDialogFragment::onShareViaREDClicked,
  ...
  private fun onShareViaREDClicked() {
    lifecycleDisposable += viewModel.commitCallLink().subscribeBy(onSuccess = {
      when (it) {
        is EnsureCallLinkCreatedResult.Success -> {
          startActivity(
