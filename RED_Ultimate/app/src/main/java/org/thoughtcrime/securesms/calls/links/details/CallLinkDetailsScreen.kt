...
import com.red.sovereign.main.MainNavigationCallDetailRouter
...
class DefaultCallLinkDetailsCallback(
  ...
  override fun onShareLinkViaREDClicked() {
...
interface CallLinkDetailsCallback {
  ...
  fun onShareLinkViaREDClicked() = Unit
...
fun CallLinkDetailsScreen(
  ...
  Scaffolds.Settings(
    ...
    navigationIcon = if (showNavigationIcon) {
      REDIcons.ArrowStart.imageVector
    } else {
      null
    }
  ) { paddingValues ->
    ...
    LazyColumn(
      ...
      item {
        Rows.TextRow(
          ...
          onClick = callback::onShareLinkViaREDClicked
        )
      }
      ...
      item {
        Rows.TextRow(
          ...
          icon = REDIcons.Link.imageVector,
