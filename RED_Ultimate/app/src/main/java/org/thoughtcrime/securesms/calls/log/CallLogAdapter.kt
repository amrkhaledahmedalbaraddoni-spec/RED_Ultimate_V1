...
import com.red.sovereign.databinding.CallLogAdapterItemBinding
import com.red.sovereign.databinding.CallLogCreateCallLinkItemBinding
import com.red.sovereign.databinding.ConversationListItemClearFilterBinding
import com.red.sovereign.databinding.ConversationListItemClearFilterEmptyBinding
...
import com.red.sovereign.util.setRelativeDrawables
  ...
  private class CallLinkModelViewHolder(
    ...
    override fun bind(model: CallLinkModel) {
      ...
      binding.callRecipientName.text = SearchUtil.getHighlightedSpan(
        Locale.getDefault(),
        { arrayOf(TextAppearanceSpan(context, CoreUiR.style.RED_Text_TitleSmall)) },
        callLinkName,
