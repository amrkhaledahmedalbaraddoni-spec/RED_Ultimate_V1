...
import com.red.sovereign.calls.links.create.CreateCallLinkBottomSheetDialogFragment
...
import com.red.sovereign.conversation.REDBottomActionBarController
import com.red.sovereign.conversation.v2.ConversationDialogs
import com.red.sovereign.conversationlist.ConversationFilterBehavior
import com.red.sovereign.conversationlist.chatfilter.ConversationFilterSource
import com.red.sovereign.conversationlist.chatfilter.ConversationListFilterPullView.OnCloseClicked
import com.red.sovereign.conversationlist.chatfilter.ConversationListFilterPullView.OnFilterStateChanged
import com.red.sovereign.conversationlist.chatfilter.FilterLerp
import com.red.sovereign.conversationlist.chatfilter.FilterPullState
import com.red.sovereign.databinding.CallLogFragmentBinding
...
class CallLogFragment : Fragment(R.layout.call_log_fragment), CallLogAdapter.Callbacks, CallLogContextMenu.Callbacks {
  ...
  private lateinit var signalBottomActionBarController: REDBottomActionBarController
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    signalBottomActionBarController = REDBottomActionBarController(
    ...
    binding.pullView.onFilterStateChanged = OnFilterStateChanged { state: FilterPullState?, source: ConversationFilterSource ->
      when (state) {
        ...
        FilterPullState.OPEN_APEX -> if (source === ConversationFilterSource.DRAG) {
          // SIGNAL_INHERITED: TODO[alex] -- hint here? REDStore.uiHints.incrementNeverDisplayPullToFilterTip()
        }
  ...
  private inner class BottomActionBarControllerCallback : REDBottomActionBarController.Callback {
