...
import com.red.sovereign.components.emoji.EmojiEditText;
import com.red.sovereign.components.mention.MentionAnnotation;
import com.red.sovereign.components.mention.MentionDeleter;
import com.red.sovereign.components.mention.MentionRendererDelegate;
import com.red.sovereign.components.mention.MentionValidatorWatcher;
import com.red.sovereign.components.spoiler.SpoilerRendererDelegate;
...
import static com.red.sovereign.database.MentionUtil.MENTION_STARTER;
...
public class ComposeText extends EmojiEditText {
  ...
  public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
    ...
    if (REDStore.settings().isEnterKeySends()) {
  ...
  @Override
  protected boolean shouldPersistREDStylingWhenPasting() {
    return true;
  }
