...
open class InsetAwareConstraintLayout @JvmOverloads constructor(
  ...
  private fun getKeyboardHeight(): Int {
    val height = if (isLandscape()) {
      REDStore.misc.keyboardLandscapeHeight
    } else {
      REDStore.misc.keyboardPortraitHeight
    }
  ...
  private fun setKeyboardHeight(height: Int) {
    if (isLandscape()) {
      REDStore.misc.keyboardLandscapeHeight = height
    } else {
      REDStore.misc.keyboardPortraitHeight = height
    }
  }
