...
import com.red.sovereign.components.emoji.EmojiImageView;
import com.red.sovereign.components.emoji.EmojiTextView;
import com.red.sovereign.components.mention.MentionAnnotation;
import com.red.sovereign.components.quotes.QuoteViewColorTheme;
...
public class QuoteView extends ConstraintLayout implements RecipientForeverObserver {
                            ...
                            @Nullable String quoteTargetContentType)
  {
    ...
    if (!TextUtils.isEmpty(body) || !attachments.containsMediaSlide()) {
      if (textPostModel != null) {
        ...
        CharSequence glyph = REDSymbols.getSpannedString(getContext(), REDSymbols.Weight.REGULAR, REDSymbols.Glyph.POLL, -1);
        // SIGNAL_INHERITED: TODO(michelle): Update with RTL poll icon
                                  ...
                                  @Nullable String quoteTargetContentType)
  {
    ...
    // SIGNAL_INHERITED: TODO [alex] -- do we need this? mainView.setMinimumHeight(isStoryReply() && originalMissing ? 0 : thumbHeight);
