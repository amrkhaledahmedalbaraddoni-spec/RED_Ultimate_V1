...
import org.signal.glide.load.REDDownsampleStrategy;
import com.red.sovereign.R;
import com.red.sovereign.attachments.Attachment;
import com.red.sovereign.attachments.DatabaseAttachment;
import com.red.sovereign.components.transfercontrols.TransferControlView;
import com.red.sovereign.components.transfercontrols.TransferControls;
import com.red.sovereign.database.AttachmentTable;
import com.red.sovereign.glide.targets.GlideBitmapListeningTarget;
import com.red.sovereign.glide.targets.GlideDrawableListeningTarget;
...
public class ThumbnailView extends FrameLayout {
                                                    ...
                                                    int naturalWidth, int naturalHeight, @ColorInt int missingBackgroundColor)
  {
    ...
    if (slideAttachment instanceof DatabaseAttachment) {
      ...
      if (REDStore.internal().getShowArchiveStateHint()) {
  ...
  public ListenableFuture<Boolean> setImageResource(@NonNull RequestManager requestManager, @NonNull Uri uri, int width, int height, boolean animate, @Nullable ThumbnailRequestListener listener) {
    ...
    RequestBuilder<Drawable> request = requestManager.load(glideModel)
                                                  ...
                                                  .downsample(REDDownsampleStrategy.CENTER_OUTSIDE_NO_UPSCALE)
                                                  .listener(listener);
