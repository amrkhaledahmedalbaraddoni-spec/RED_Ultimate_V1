...
import com.red.sovereign.components.subsampling.AttachmentBitmapDecoder;
import com.red.sovereign.components.subsampling.AttachmentRegionDecoder;
import org.signal.glide.decryptableuri.DecryptableUri;
import com.red.sovereign.mms.PartAuthority;
import com.red.sovereign.util.ActionRequestListener;
...
public class ZoomingImageView extends FrameLayout {
  ...
  private void setSubsamplingImageViewUri(@NonNull Uri uri) {
    ...
    // https://github.com/signalapp/RED-Android/issues/11732#issuecomment-963203545
    try {
