...
import com.red.sovereign.components.emoji.EmojiProvider.EmojiDrawable;
import com.red.sovereign.keyvalue.REDStore;
import com.red.sovereign.util.EditTextExtensionsKt;
...
public class EmojiEditText extends AppCompatEditText {
  ...
  public EmojiEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (!isInEditMode() && !REDStore.settings().isPreferSystemEmoji()) {
  ...
  public boolean onTextContextMenuItem(int id) {
    if (id == android.R.id.paste) {
      ...
      if (clipData != null) {
        ...
        if (TextUtils.equals(Util.COPY_LABEL, label) && shouldPersistREDStylingWhenPasting()) {
