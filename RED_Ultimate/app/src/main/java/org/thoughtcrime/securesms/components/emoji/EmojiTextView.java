package com.red.sovereign.components.emoji;
...
public class EmojiTextView extends AppCompatTextView {
  ...
  private Executor     backgroundExecutor = new SerialMonoLifoExecutor(REDExecutors.UNBOUNDED);
  ...
  private boolean useSystemEmoji() {
    return isInEditMode() || REDStore.settings().isPreferSystemEmoji();
  }
