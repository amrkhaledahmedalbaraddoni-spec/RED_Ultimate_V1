package com.red.sovereign.components.location;
...
public class REDMapView extends LinearLayout {
  ...
  public REDMapView(Context context, AttributeSet attrs) {
    super(context, attrs);
    initialize(context);
  }

  public REDMapView(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  public ListenableFuture<Bitmap> display(final REDPlace place) {
  ...
  public static ListenableFuture<Bitmap> snapshot(final REDPlace place, @NonNull final MapView mapView) {
