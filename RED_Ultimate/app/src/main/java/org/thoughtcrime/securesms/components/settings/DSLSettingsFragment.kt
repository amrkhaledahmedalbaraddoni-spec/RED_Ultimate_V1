...
abstract class DSLSettingsFragment(
  ...
  /**
   * All host windows are edge-to-edge — activities centrally via [com.red.sovereign.BaseActivity],
   * and the full-screen dialog hosts ([com.red.sovereign.components.WrapperDialogFragment],
   * [com.red.sovereign.stories.settings.create.CreateStoryFlowDialogFragment]) via their own
