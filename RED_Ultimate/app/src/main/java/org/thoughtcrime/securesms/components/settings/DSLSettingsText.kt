...
sealed class DSLSettingsText {
  ...
  object TitleLargeModifier : TextAppearanceModifier(CoreUiR.style.RED_Text_TitleLarge)
  object TitleMediumModifier : TextAppearanceModifier(CoreUiR.style.RED_Text_TitleMedium)
  object BodyLargeModifier : TextAppearanceModifier(CoreUiR.style.RED_Text_BodyLarge)
