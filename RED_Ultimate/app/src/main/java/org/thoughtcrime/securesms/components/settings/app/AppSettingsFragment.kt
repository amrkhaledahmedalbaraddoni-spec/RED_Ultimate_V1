...
import com.red.sovereign.components.settings.app.routes.AppSettingsRouter
import com.red.sovereign.components.settings.app.subscription.BadgeImageMedium
      ...
      repeatOnLifecycle(Lifecycle.State.RESUMED) {
        appSettingsRouter.currentRoute.collect { route ->
          when (route) {
            ...
            is AppSettingsRoute.AccountRoute.Account -> if (REDStore.account.isPrimaryDevice) {
  ...
  Scaffolds.Settings(
    ...
    Column(
      ...
      LazyColumn {
          ...
          BackupFailureState.OUT_OF_STORAGE_SPACE -> {
            item {
              ...
              Rows.TextRow(
                ...
                icon = REDIcons.ErrorCircle.imageVector,
        ...
        item {
          Rows.TextRow(
            icon = REDIcons.Backup.imageVector,
  ...
  Row(
    ...
    Column(
      ...
      val prettyPhoneNumber = if (LocalInspectionMode.current) {
        ...
        remember(self.e164) {
          REDE164Util.prettyPrint(self.e164)
        }
      }
    ...
    if (hasUsername) {
      IconButtons.IconButton(
        ...
        colors = IconButtons.iconButtonColors(
          containerColor = REDTheme.colors.colorSurface4
        )
      ) {
        Icon(
          painter = REDIcons.QrCode.painter,
          contentDescription = null,
