package com.red.sovereign.components.settings.app.appearance.navbar
...
import com.red.sovereign.databinding.ChooseNavigationBarStyleFragmentBinding
...
class ChooseNavigationBarStyleFragment : DialogFragment(R.layout.choose_navigation_bar_style_fragment) {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    presentToggleState(REDStore.settings.useCompactNavigationBar)
    ...
    binding.ok.setOnClickListener {
      ...
      REDStore.settings.useCompactNavigationBar = isCompact
