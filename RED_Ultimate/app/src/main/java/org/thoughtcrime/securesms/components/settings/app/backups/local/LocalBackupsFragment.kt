...
import com.red.sovereign.backup.v2.ui.subscription.MessageBackupsKeyEducationScreen
import com.red.sovereign.backup.v2.ui.subscription.MessageBackupsKeyEducationScreenMode
          ...
          when (key) {
            ...
            LocalBackupsNavKey.YOUR_RECOVERY_KEY -> NavEntry(key) {
              ...
              MessageBackupsKeyEducationScreen(
                ...
                } else if (REDStore.backup.areBackupsEnabled) {
...
private fun rememberChooseBackupLocationLauncher(backStack: NavBackStack<NavKey>): ActivityResultLauncher<Uri?> {
  ...
  return Launchers.rememberOpenDocumentTreeLauncher { uri ->
    if (uri != null) {
      ...
      REDStore.backup.newLocalBackupsDirectory = uri.toString()
