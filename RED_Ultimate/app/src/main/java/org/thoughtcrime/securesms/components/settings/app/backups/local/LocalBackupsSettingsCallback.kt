...
import com.red.sovereign.jobs.LocalBackupJob.enqueueArchive
...
class DefaultLocalBackupsSettingsCallback(
  ...
  override fun onLaunchBackupLocationPickerClick() {
    try {
      ...
      chooseBackupLocationLauncher.launch(REDStore.settings.latestREDBackupDirectory)
  ...
  override fun onPickTimeClick() {
    ...
    val picker = MaterialTimePicker.Builder()
      ...
      .setHour(REDStore.settings.backupHour)
      .setMinute(REDStore.settings.backupMinute)
      .setTitleText(R.string.BackupsPreferenceFragment__set_backup_time)
      .build()

    picker.addOnPositiveButtonClickListener {
      REDStore.settings.setBackupSchedule(picker.hour, picker.minute)
