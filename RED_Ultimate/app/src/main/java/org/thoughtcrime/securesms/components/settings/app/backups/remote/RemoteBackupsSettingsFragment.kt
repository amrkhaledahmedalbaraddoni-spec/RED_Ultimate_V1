...
import com.red.sovereign.backup.v2.ui.status.BackupCreateErrorRow
import com.red.sovereign.backup.v2.ui.status.BackupStatusRow
import com.red.sovereign.backup.v2.ui.status.RestoreType
import com.red.sovereign.backup.v2.ui.subscription.MessageBackupsType
import com.red.sovereign.billing.launchManageBackupsSubscription
import com.red.sovereign.components.compose.BiometricsAuthentication
import com.red.sovereign.components.compose.rememberBiometricsAuthentication
...
import com.red.sovereign.components.settings.app.subscription.MessageBackupsCheckoutLauncher.createBackupsCheckoutLauncher
import com.red.sovereign.help.HelpFragment
...
class RemoteBackupsSettingsFragment : ComposeFragment() {
  ...
  override fun FragmentContent() {
    ...
    val deleteState by REDStore.backup.deletionStateFlow.collectAsStateWithLifecycle(initialValue = REDStore.backup.deletionState)
  ...
  private inner class Callbacks : ContentCallbacks {
    ...
    override fun onFreeTierBackupSizeLearnMore() {
      CommunicationActions.openBrowserLink(requireContext(), "https://support.red.local/hc/articles/9708267671322")
    }
      ...
      item {
        Column(
          modifier = Modifier
            ...
            .background(color = REDTheme.colors.colorSurface2, shape = RoundedCornerShape(12.dp))
            .padding(24.dp)
        ) {
          Text(
...
private fun CallToActionButton(
  ...
  Buttons.MediumTonal(
    ...
    colors = ButtonDefaults.filledTonalButtonColors().copy(
      containerColor = REDTheme.colors.colorTransparent5,
...
private fun OutOfStorageSpaceBlock(
  ...
  Row(
    ...
    Icon(
      imageVector = REDIcons.ErrorCircle.imageVector,
      ...
      Box {
        ...
        Box(
          modifier = Modifier
            ...
            .border(5.dp, color = REDTheme.colors.colorSurface2, shape = CircleShape)
