...
import com.red.sovereign.components.settings.app.internal.donor.DonationErrorValueCodeSelector
import com.red.sovereign.components.settings.app.internal.donor.DonationErrorValueTypeSelector
...
class InternalPendingOneTimeDonationConfigurationFragment : ComposeFragment() {
  ...
  override fun FragmentContent() {
    ...
    Content(
      ...
      onSave = {
        REDStore.inAppPayments.setPendingOneTimeDonation(viewModel.state.value)
        findNavController().popBackStack()
      }
    )
  }
