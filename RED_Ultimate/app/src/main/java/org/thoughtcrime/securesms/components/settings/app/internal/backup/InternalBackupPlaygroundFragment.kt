...
import com.red.sovereign.backup.isIdle
...
import com.red.sovereign.backup.v2.ui.status.BackupCreationProgressRow
import com.red.sovereign.components.settings.app.internal.backup.InternalBackupPlaygroundViewModel.DialogState
import com.red.sovereign.components.settings.app.internal.backup.InternalBackupPlaygroundViewModel.ScreenState
import com.red.sovereign.dependencies.AppDependencies
import com.red.sovereign.jobs.ArchiveAttachmentBackfillJob
import com.red.sovereign.jobs.ArchiveAttachmentReconciliationJob
        ...
        TopAppBar(
          ...
          navigationIcon = {
            IconButton(onClick = onBack) {
              Icon(
                painter = REDIcons.ArrowStart.painter,
  ...
  Surface {
    Column(
      ...
      Rows.TextRow(
        ...
        onClick = {
          Util.copyToClipboard(context, REDStore.account.accountEntropyPool.displayValue)
      ...
      Rows.TextRow(
        ...
        onClick = {
          Util.copyToClipboard(context, Hex.toStringCondensed(REDStore.account.accountEntropyPool.deriveMessageBackupKey().value))
          Toast.makeText(context, "Copied!", Toast.LENGTH_SHORT).show()
        }
      )
      ...
      Rows.TextRow(
        ...
        onClick = {
          Util.copyToClipboard(context, Base64.encodeWithoutPadding(REDStore.backup.mediaRootBackupKey.deriveBackupId(REDStore.account.requireAci()).value))
          Toast.makeText(context, "Copied!", Toast.LENGTH_SHORT).show()
        }
      )
