...
import com.red.sovereign.components.settings.app.notifications.profiles.AddAllowedMembersViewModel.NotificationProfileAndRecipients
      ...
      LazyColumn(
        ...
        item {
          Rows.ToggleRow(
            ...
            icon = REDIcons.Phone.imageVector,
