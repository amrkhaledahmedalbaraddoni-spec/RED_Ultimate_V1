...
class PrivacySettingsViewModel(
  ...
  fun togglePaymentLock(enable: Boolean) {
    REDStore.payments.paymentLock = enable
    refresh()
  }

  fun setObsoletePasswordTimeoutEnabled(enabled: Boolean) {
    REDStore.settings.passphraseTimeoutEnabled = enabled
    refresh()
  }

  fun setObsoletePasswordTimeout(minutes: Int) {
    REDStore.settings.passphraseTimeout = minutes
    refresh()
  }
  ...
  private fun getState(): PrivacySettingsState {
    return PrivacySettingsState(
      ...
      paymentLock = REDStore.payments.paymentLock,
      isObsoletePasswordEnabled = !REDStore.settings.passphraseDisabled,
      isObsoletePasswordTimeoutEnabled = REDStore.settings.passphraseTimeoutEnabled,
      obsoletePasswordTimeout = REDStore.settings.passphraseTimeout,
