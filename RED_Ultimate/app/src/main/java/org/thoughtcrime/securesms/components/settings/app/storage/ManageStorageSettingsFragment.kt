...
import com.red.sovereign.billing.upgrade.UpgradeToEnableOptimizedStorageSheet
...
import com.red.sovereign.preferences.widgets.StorageGraphView
      ...
      NavHost(
        ...
        dialog("confirm-delete-chat-history") {
          Dialogs.SimpleAlertDialog(
            ...
            body = if (REDStore.account.isMultiDevice) {
      ...
      Rows.RadioRow(
        content = {
          ...
          if (customSelected) {
            ...
            Icon(
              painter = REDIcons.Settings.painter,
