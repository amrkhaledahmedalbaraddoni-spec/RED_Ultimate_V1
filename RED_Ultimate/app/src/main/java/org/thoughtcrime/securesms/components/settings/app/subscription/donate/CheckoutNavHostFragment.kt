  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    navGraph.setStartDestination(
      when (inAppPaymentType) {
        ...
        InAppPaymentType.ONE_TIME_DONATION, InAppPaymentType.RECURRING_DONATION -> R.id.donateToREDFragment
    ...
    val startBundle = if (savedInstanceState == null) {
      when (inAppPaymentType) {
        ...
        InAppPaymentType.ONE_TIME_DONATION, InAppPaymentType.RECURRING_DONATION -> DonateToREDFragmentArgs.Builder(inAppPaymentType).build().toBundle()
      }
    } else {
      null
    }
