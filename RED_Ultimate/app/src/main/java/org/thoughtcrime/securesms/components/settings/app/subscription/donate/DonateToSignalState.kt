...
import com.red.sovereign.database.model.isLongRunning
import com.red.sovereign.database.model.isPending
...
data class DonateToREDState(
  ...
  data class OneTimeDonationState(
    ...
    val selectedCurrency: Currency = REDStore.inAppPayments.getOneTimeCurrency(),
  ...
  data class MonthlyDonationState(
    val selectedCurrency: Currency = REDStore.inAppPayments.getRecurringDonationCurrency(),
