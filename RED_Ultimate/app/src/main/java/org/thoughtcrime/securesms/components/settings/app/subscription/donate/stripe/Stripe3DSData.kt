...
import com.red.sovereign.database.model.databaseprotos.ExternalLaunchTransactionState
    ...
    fun fromProtoBytes(byteArray: ByteArray): Stripe3DSData {
      ...
      return Stripe3DSData(
        ...
        inAppPayment = InAppPaymentTable.InAppPayment(
          id = InAppPaymentTable.InAppPaymentId(-1), // SIGNAL_INHERITED: TODO [alex] -- can we start writing this in for new transactions?
