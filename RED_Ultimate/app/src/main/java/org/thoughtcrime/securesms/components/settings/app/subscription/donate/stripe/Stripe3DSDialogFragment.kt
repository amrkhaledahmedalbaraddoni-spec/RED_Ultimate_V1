...
import com.red.sovereign.components.settings.app.subscription.donate.DonationWebViewOnBackPressedCallback
import com.red.sovereign.database.REDDatabase
import com.red.sovereign.database.model.databaseprotos.InAppPaymentData
import com.red.sovereign.databinding.DonationWebviewFragmentBinding
  ...
  private fun handleLaunchExternal(intent: Intent) {
    lifecycleScope.launch {
      ...
      withContext(Dispatchers.Default) {
        REDDatabase.inAppPayments.update(args.waitingForAuthPayment)
      }
