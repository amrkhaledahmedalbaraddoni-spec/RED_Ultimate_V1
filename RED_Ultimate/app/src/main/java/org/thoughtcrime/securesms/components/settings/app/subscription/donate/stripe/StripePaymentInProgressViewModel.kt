package com.red.sovereign.components.settings.app.subscription.donate.stripe
...
import com.red.sovereign.components.settings.app.subscription.donate.InAppPaymentProcessorStage
import com.red.sovereign.components.settings.app.subscription.donate.RequiredActionHandler
import com.red.sovereign.components.settings.app.subscription.donate.SharedInAppPaymentPipeline
    ...
    disposables += iap.flatMap { inAppPayment ->
      RecurringInAppPaymentRepository
        ...
        .flatMap { paymentSourceType ->
          val freshPayment = REDDatabase.inAppPayments.moveToTransacting(inAppPayment.id)!!
