...
package com.red.sovereign.components.settings.app.subscription.donate.transfer.details
...
import com.red.sovereign.components.settings.app.subscription.donate.transfer.details.BankTransferDetailsViewModel.Field
...
class BankTransferDetailsFragment : ComposeFragment(), InAppPaymentCheckoutDelegate.ErrorHandlerCallback {
  ...
  private fun ReadyContent(
    ...
    val donateLabel = remember(inAppPayment) {
      if (inAppPayment.type.recurring) { // SIGNAL_INHERITED: TODO [message-requests] backups copy
        getString(
