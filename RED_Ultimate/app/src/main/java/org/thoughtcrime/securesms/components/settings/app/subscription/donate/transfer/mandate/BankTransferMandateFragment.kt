  ...
  Scaffold(
    topBar = {
      TopAppBar(
        ...
        colors = if (listState.canScrollBackward) TopAppBarDefaults.topAppBarColors(containerColor = REDTheme.colors.colorSurface2) else TopAppBarDefaults.topAppBarColors()
      )
    }
  ) { paddingValues ->
    Column(
