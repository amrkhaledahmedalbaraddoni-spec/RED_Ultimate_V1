...
import com.red.sovereign.badges.gifts.ExpiredGiftSheet
...
import com.red.sovereign.components.settings.models.IndeterminateLoadingCircle
...
class ManageDonationsFragment :
  ...
  companion object {
    ...
    const val DONATE_TROUBLESHOOTING_URL = "https://support.red.local/hc/articles/360031949872#fix"
  }
  ...
  override fun bindAdapter(adapter: MappingAdapter) {
    ...
    val expiredGiftBadge = REDStore.inAppPayments.getExpiredGiftBadge()
  ...
  private fun DSLConfiguration.presentNetworkFailureSettings(state: ManageDonationsState, hasReceipts: Boolean) {
    if (REDStore.inAppPayments.isLikelyASustainer()) {
