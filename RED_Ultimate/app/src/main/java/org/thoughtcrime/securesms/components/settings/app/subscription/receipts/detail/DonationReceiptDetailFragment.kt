...
import com.red.sovereign.components.settings.app.subscription.receipts.ReceiptImageRenderer
...
class DonationReceiptDetailFragment : DSLSettingsFragment(layoutId = R.layout.donation_receipt_detail_fragment) {
  ...
  private lateinit var progressDialog: REDProgressDialog
    ...
    viewModel.state.observe(viewLifecycleOwner) { state ->
      if (state.inAppPaymentReceiptRecord != null) {
        ...
        sharePngButton.setOnClickListener {
          progressDialog = REDProgressDialog.show(requireContext())
    ...
    return configure {
      ...
      textPref(
        title = DSLSettingsText.from(
          ...
          DSLSettingsText.TextAppearanceModifier(CoreUiR.style.RED_Text_Giant),
