package com.red.sovereign.components.settings.app.usernamelinks
...
/**
 * Shows a QRCode that represents the provided data. Includes a RED logo in the middle.
 */
@Composable
fun QrCode(
  data: QrCodeData,
...
private fun Preview() {
  Surface {
    QrCode(
      data = QrCodeData.forData("https://red.local"),
