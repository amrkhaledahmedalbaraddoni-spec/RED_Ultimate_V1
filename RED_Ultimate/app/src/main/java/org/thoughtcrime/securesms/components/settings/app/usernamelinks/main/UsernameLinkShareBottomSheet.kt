...
class UsernameLinkShareBottomSheet : ComposeBottomSheetDialogFragment() {
  ...
  override fun SheetContent() {
    Content(
      usernameLink = REDStore.account.usernameLink?.toLink() ?: "",
...
private fun ButtonRowPreview() {
  Previews.Preview {
    Surface {
      ButtonRow(icon = REDIcons.Share.painter, text = "Share")
    }
  }
}
