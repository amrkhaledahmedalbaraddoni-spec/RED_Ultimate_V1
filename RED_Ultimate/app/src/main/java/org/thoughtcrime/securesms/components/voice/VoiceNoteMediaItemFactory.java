...
class VoiceNoteMediaItemFactory {
  ...
  {
    int startingPosition = REDDatabase.messages()
                                         .getMessagePositionInConversation(messageRecord.getThreadId(),
                                                                           messageRecord.getDateReceived());

    Recipient threadRecipient = Objects.requireNonNull(REDDatabase.threads()
                                          ...
                                          @NonNull Uri audioUri)
  {
    ...
    NotificationPrivacyPreference preference = REDStore.settings().getMessageNotificationsPrivacy();
