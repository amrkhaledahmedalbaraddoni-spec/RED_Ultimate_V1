...
public class VoiceNotePlaybackService extends MediaSessionService {
  ...
  public static final String ACTION_NEXT_PLAYBACK_SPEED = "com.red.sovereign.components.voice.VoiceNotePlaybackService.action.next_playback_speed";
  public static final String ACTION_SET_AUDIO_STREAM    = "com.red.sovereign.components.voice.VoiceNotePlaybackService.action.set_audio_stream";
    ...
    ContextCompat.getMainExecutor(getApplicationContext()).execute(() -> {
      ...
      for (int i = player.getMediaItemCount() - 1; i >= 0; i--) {
        ...
        try {
          ...
          DatabaseAttachment attachment = REDDatabase.attachments().getAttachment(partId);
  ...
  private void sendViewedReceiptForCurrentWindowIndex() {
        ...
        player.getCurrentMediaItemIndex() != C.INDEX_UNSET)
    {
      ...
      REDExecutors.BOUNDED.execute(() -> {
        ...
        MessageTable messageDatabase = REDDatabase.messages();
