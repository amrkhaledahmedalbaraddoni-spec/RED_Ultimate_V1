...
private fun getDrawableResourceForDeviceType(deviceType: REDAudioManager.AudioDevice): Int {
  return when (deviceType) {
    REDAudioManager.AudioDevice.WIRED_HEADSET -> R.drawable.symbol_headphones_outline_24
    REDAudioManager.AudioDevice.EARPIECE -> R.drawable.symbol_phone_speaker_outline_24
    REDAudioManager.AudioDevice.BLUETOOTH -> R.drawable.symbol_speaker_bluetooth_fill_white_24
    REDAudioManager.AudioDevice.SPEAKER_PHONE, REDAudioManager.AudioDevice.NONE -> R.drawable.symbol_speaker_outline_24
  }
}

private fun getDescriptionStringResourceForDeviceType(deviceType: REDAudioManager.AudioDevice): Int {
  return when (deviceType) {
    REDAudioManager.AudioDevice.WIRED_HEADSET -> R.string.WebRtcAudioOutputBottomSheet__headset_icon_content_description
    REDAudioManager.AudioDevice.EARPIECE -> R.string.WebRtcAudioOutputBottomSheet__earpiece_icon_content_description
    REDAudioManager.AudioDevice.BLUETOOTH -> R.string.WebRtcAudioOutputBottomSheet__bluetooth_icon_content_description
    REDAudioManager.AudioDevice.SPEAKER_PHONE, REDAudioManager.AudioDevice.NONE -> R.string.WebRtcAudioOutputBottomSheet__speaker_icon_content_description
  }
}

data class AudioOutputOption(val friendlyName: String, val deviceType: REDAudioManager.AudioDevice, val deviceId: Int)

@Preview
@Composable
private fun SampleOutputBottomSheet() {
  val outputs: ImmutableList<AudioOutputOption> = listOf(
    AudioOutputOption("Earpiece", REDAudioManager.AudioDevice.EARPIECE, 0),
    AudioOutputOption("Speaker", REDAudioManager.AudioDevice.SPEAKER_PHONE, 1),
    AudioOutputOption("BT Headset", REDAudioManager.AudioDevice.BLUETOOTH, 2),
    AudioOutputOption("Wired Headset", REDAudioManager.AudioDevice.WIRED_HEADSET, 3)
  ).toImmutableList()
