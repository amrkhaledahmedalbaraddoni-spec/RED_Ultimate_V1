...
public final class WebRtcControls {
  ...
  public static final WebRtcControls PIP  = new WebRtcControls(false,
                                                               ...
                                                               null,
                                                               FoldableState.flat(),
                                                               REDAudioManager.AudioDevice.NONE,
                                                               emptySet(),
                                                               false,
                                                               false);
  ...
  private final REDAudioManager.AudioDevice      activeDevice;
  private final Set<REDAudioManager.AudioDevice> availableDevices;
  ...
  public WebRtcControls(boolean isLocalVideoEnabled,
                 ...
                 @NonNull REDAudioManager.AudioDevice activeDevice,
                 @NonNull Set<REDAudioManager.AudioDevice> availableDevices,
                 boolean isCallLink,
  ...
  public boolean isBluetoothHeadsetAvailableForAudioToggle() {
    return availableDevices.contains(REDAudioManager.AudioDevice.BLUETOOTH);
  }

  public boolean isWiredHeadsetAvailableForAudioToggle() {
    return availableDevices.contains(REDAudioManager.AudioDevice.WIRED_HEADSET);
  }
