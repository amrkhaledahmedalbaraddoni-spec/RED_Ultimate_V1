...
import com.red.sovereign.avatar.fallback.FallbackAvatarImage
import com.red.sovereign.components.AvatarImageView
import com.red.sovereign.components.webrtc.v2.WebRtcCallViewModel
  ...
  Box(modifier = Modifier.width(40.dp)) {
    ...
    FallbackAvatarImage(
      ...
      modifier = Modifier
        ...
        .border(width = 2.dp, color = REDTheme.colors.colorSurface1, shape = CircleShape)
    )
  }
}
