...
import com.red.sovereign.components.webrtc.CallLinkProfileKeySender
...
import com.red.sovereign.components.webrtc.InCallStatus
import com.red.sovereign.components.webrtc.PendingParticipantsBottomSheet
import com.red.sovereign.components.webrtc.WebRtcAudioDevice
import com.red.sovereign.components.webrtc.WebRtcAudioOutput
import com.red.sovereign.components.webrtc.WebRtcControls
import com.red.sovereign.components.webrtc.requests.CallLinkIncomingRequestSheet
import com.red.sovereign.conversation.ui.error.SafetyNumberChangeDialog
import com.red.sovereign.dependencies.AppDependencies
import com.red.sovereign.events.WebRtcViewModel
import com.red.sovereign.keyvalue.REDStore
import com.red.sovereign.messagerequests.CalleeMustAcceptMessageRequestActivity
...
import com.red.sovereign.webrtc.CallParticipantsViewState
import com.red.sovereign.webrtc.audio.REDAudioManager
import com.red.sovereign.webrtc.audio.REDAudioManager.ChosenAudioDeviceIdentifier
...
class WebRtcCallActivity : BaseActivity(), SafetyNumberChangeDialog.Callback, ReactWithAnyEmojiBottomSheetDialogFragment.Callback, RecaptchaProofBottomSheetFragment.Callback {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    windowInfoTrackerCallbackAdapter.addWindowLayoutInfoListener(this, REDExecutors.BOUNDED, windowLayoutInfoConsumer)
  ...
  private suspend fun observeVideoSinkAspectRatio(videoSink: com.red.sovereign.components.webrtc.BroadcastVideoSink?) {
  ...
  private fun handleSetAudioHandset() {
    AppDependencies.signalCallManager.selectAudioDevice(ChosenAudioDeviceIdentifier(REDAudioManager.AudioDevice.EARPIECE))
  }

  private fun handleSetAudioSpeaker() {
    AppDependencies.signalCallManager.selectAudioDevice(ChosenAudioDeviceIdentifier(REDAudioManager.AudioDevice.SPEAKER_PHONE))
  }

  private fun handleSetAudioBluetooth() {
    AppDependencies.signalCallManager.selectAudioDevice(ChosenAudioDeviceIdentifier(REDAudioManager.AudioDevice.BLUETOOTH))
  }

  private fun handleSetAudioWiredHeadset() {
    AppDependencies.signalCallManager.selectAudioDevice(ChosenAudioDeviceIdentifier(REDAudioManager.AudioDevice.WIRED_HEADSET))
  }
  ...
  private fun handleCallBusy() {
    ...
    delayedFinish(REDCallManager.BUSY_TONE_LENGTH.toLong())
  }
