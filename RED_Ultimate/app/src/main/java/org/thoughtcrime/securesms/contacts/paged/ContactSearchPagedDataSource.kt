...
import com.red.sovereign.contacts.paged.collections.ContactSearchCollection
import com.red.sovereign.contacts.paged.collections.ContactSearchIterator
import com.red.sovereign.contacts.paged.collections.CursorSearchIterator
import com.red.sovereign.contacts.paged.collections.StoriesSearchCollection
...
import com.red.sovereign.search.MessageSearchResult
import com.red.sovereign.search.SearchRepository
import com.red.sovereign.search.ThreadSearchResult
...
class ContactSearchPagedDataSource(
  ...
  override fun load(start: Int, length: Int, totalSize: Int, cancellationRED: PagedDataSource.CancellationRED): MutableList<ContactSearchData> {
  ...
  private fun getNonGroupSearchIterator(section: ContactSearchConfiguration.Section.Individuals, query: String?): ContactSearchIterator<Cursor> {
    ...
    return CursorSearchIterator(wrapRecipientCursor(contactSearchPagedDataSourceRepository.queryREDContacts(searchQuery)))
  }
