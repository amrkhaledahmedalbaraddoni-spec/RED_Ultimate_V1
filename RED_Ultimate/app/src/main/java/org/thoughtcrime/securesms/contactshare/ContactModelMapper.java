...
import static com.red.sovereign.contactshare.Contact.Avatar;
import static com.red.sovereign.contactshare.Contact.Email;
import static com.red.sovereign.contactshare.Contact.Name;
import static com.red.sovereign.contactshare.Contact.Phone;
import static com.red.sovereign.contactshare.Contact.PostalAddress;
...
public class ContactModelMapper {
  ...
  public static Contact remoteToLocal(@NonNull DataMessage.Contact contact) {
    ...
    if (contact.avatar != null && contact.avatar.avatar != null) {
      try {
        REDServiceAttachmentPointer attachmentPointer = AttachmentPointerUtil.createREDAttachmentPointer(contact.avatar.avatar);
