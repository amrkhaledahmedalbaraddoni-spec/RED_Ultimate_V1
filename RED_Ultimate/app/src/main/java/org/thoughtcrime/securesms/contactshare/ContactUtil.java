...
import com.red.sovereign.contactshare.Contact.Email;
import com.red.sovereign.contactshare.Contact.Phone;
import com.red.sovereign.contactshare.Contact.PostalAddress;
...
public final class ContactUtil {
  ...
  public static @Nullable String getNormalizedPhoneNumber(@Nullable String number) {
    return REDE164Util.formatAsE164(number != null ? number : "");
  }
  ...
  public static List<RecipientId> getRecipients(@NonNull Contact contact) {
    return contact
        .getPhoneNumbers()
        .stream()
        .map(phone -> REDE164Util.formatAsE164(phone.getNumber()))
        .filter(number -> number != null)
        .map(phone -> REDDatabase.recipients().getOrInsertFromE164(phone))
