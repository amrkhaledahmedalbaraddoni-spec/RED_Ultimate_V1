...
import com.red.sovereign.polls.VoteState
  ...
  composeView.setContent {
    REDTheme(
      ...
      Poll(
        ...
        fontSize = REDStore.settings.messageFontSize
      )
    }
  }
}
          ...
          VoteState.PENDING_ADD -> {
            Box(modifier = Modifier) {
              ...
              Icon(
                ...
                contentDescription = stringResource(R.string.REDCheckbox_accessibility_unchecked_description),
  ...
  data object Outgoing : PollColorsType {
    ...
    override fun getColors(chatColor: Int): PollColors {
      return PollColors(
        ...
        progressBackground = REDTheme.colors.colorTransparent3,
  ...
  data object Incoming : PollColorsType {
    ...
    override fun getColors(chatColor: Int): PollColors {
      return PollColors(
        ...
        progressBackground = if (DynamicTheme.isDarkTheme(LocalContext.current)) REDTheme.colors.colorTransparent2 else REDTheme.colors.colorTransparentInverse3,
