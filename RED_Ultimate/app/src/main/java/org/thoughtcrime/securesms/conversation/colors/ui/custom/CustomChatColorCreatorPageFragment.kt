...
import com.red.sovereign.conversation.colors.ui.ChatColorPreviewView
import com.red.sovereign.conversation.colors.ui.ChatColorSelectionViewModel
import com.red.sovereign.keyvalue.REDStore
import com.red.sovereign.util.SystemWindowInsetsSetter
import com.red.sovereign.util.ViewUtil
import com.red.sovereign.util.customizeOnDraw
...
class CustomChatColorCreatorPageFragment :
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    if (page == 1 && REDStore.chatColors.shouldShowGradientTooltip) {
      view.post {
        REDStore.chatColors.shouldShowGradientTooltip = false
