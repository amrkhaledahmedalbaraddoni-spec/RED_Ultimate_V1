...
import com.red.sovereign.conversation.ui.mentions.MentionViewState
import com.red.sovereign.conversation.ui.mentions.MentionsPickerRepositoryV2
import com.red.sovereign.conversation.v2.ConversationRecipientRepository
...
class InlineQueryViewModelV2(
  ...
  companion object {
    fun toMappingModels(emojiWithLabels: List<String>): List<AnyMappingModel> {
      val emojiValues = REDStore.emoji
