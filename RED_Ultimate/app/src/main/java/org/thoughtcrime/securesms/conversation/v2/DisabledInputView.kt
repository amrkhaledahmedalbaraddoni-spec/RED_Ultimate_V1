...
import com.red.sovereign.messagerequests.MessageRequestsBottomView
...
class DisabledInputView @JvmOverloads constructor(
  ...
  private var inviteToRED: View? = null
    ...
    expiredOrUnauthorized = show(
      ...
      bind = {
        ...
        when {
          ...
          unauthorized && REDStore.account.isLinkedDevice -> {
            ...
            message.setText(R.string.UnauthorizedReminder_this_is_likely_because_you_registered_your_phone_number_with_RED_on_a_different_device)
  ...
  fun showAsInviteToRED(context: Context, recipient: Recipient, threadContainsSms: Boolean) {
    inviteToRED = show(
      existingView = inviteToRED,
      ...
      bind = {
        ...
        findViewById<MaterialButton>(R.id.export_sms_button).apply {
          ...
          setOnClickListener { listener?.onInviteToRED(recipient) }
  ...
  interface Listener {
    ...
    fun onInviteToRED(recipient: Recipient)
