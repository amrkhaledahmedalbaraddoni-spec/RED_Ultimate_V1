...
class JumpToDateValidator private constructor(
  ...
  companion object {
    ...
    fun createDefaultLookup(threadId: Long): MessageDateLookup {
      return { dayStarts -> REDDatabase.messages.messageExistsOnDays(threadId, dayStarts) }
    }
    ...
    fun create(threadId: Long): JumpToDateValidator {
      return JumpToDateValidator(
        ...
        executor = REDExecutors.newCachedSingleThreadExecutor("jump-to-date-validator", ThreadUtil.PRIORITY_BACKGROUND_THREAD),
