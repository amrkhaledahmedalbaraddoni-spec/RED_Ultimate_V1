...
import com.red.sovereign.conversation.AttachmentKeyboard
import com.red.sovereign.conversation.AttachmentKeyboardButton
import com.red.sovereign.conversation.ManageContextMenu
import com.red.sovereign.conversation.v2.ConversationViewModel
...
class AttachmentKeyboardFragment : LoggingFragment(R.layout.attachment_keyboard_fragment), AttachmentKeyboard.Callback {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    attachmentKeyboardView.apply {
      ...
      if (!REDStore.payments.paymentsAvailability.isSendAllowed) {
  ...
  private fun updateButtonsAvailable(recipient: Recipient) {
    val paymentsValues = REDStore.payments
    val isPaymentsAvailable = paymentsValues.paymentsAvailability.isSendAllowed && !recipient.isSelf && !recipient.isGroup && recipient.isRegistered && REDStore.account.isPrimaryDevice
