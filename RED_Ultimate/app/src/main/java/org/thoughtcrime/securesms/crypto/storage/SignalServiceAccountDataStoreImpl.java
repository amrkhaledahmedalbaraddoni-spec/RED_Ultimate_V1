...
public class REDServiceAccountDataStoreImpl implements REDServiceAccountDataStore {

  private final Context                context;
  private final TextSecurePreKeyStore  preKeyStore;
  private final TextSecurePreKeyStore  signedPreKeyStore;
  private final REDIdentityKeyStore identityKeyStore;
  private final TextSecureSessionStore sessionStore;
  private final REDSenderKeyStore   senderKeyStore;
  private final REDKyberPreKeyStore kyberPreKeyStore;

  public REDServiceAccountDataStoreImpl(@NonNull Context context,
                                           @NonNull TextSecurePreKeyStore preKeyStore,
                                           @NonNull REDKyberPreKeyStore kyberPreKeyStore,
                                           @NonNull REDIdentityKeyStore identityKeyStore,
                                           @NonNull TextSecureSessionStore sessionStore,
                                           @NonNull REDSenderKeyStore senderKeyStore)
  {
  ...
  public void setMultiDevice(boolean isMultiDevice) {
    REDStore.account().setMultiDevice(isMultiDevice);
  }
  ...
  @Override
  public SessionRecord loadSession(REDProtocolAddress axolotlAddress) {
  ...
  @Override
  public void storeSession(REDProtocolAddress axolotlAddress, SessionRecord record) {
    sessionStore.storeSession(axolotlAddress, record);
  }

  @Override
  public boolean containsSession(REDProtocolAddress axolotlAddress) {
    return sessionStore.containsSession(axolotlAddress);
  }

  @Override
  public void deleteSession(REDProtocolAddress axolotlAddress) {
  ...
  @Override
  public void storeSenderKey(REDProtocolAddress sender, UUID distributionId, SenderKeyRecord record) {
    senderKeyStore.storeSenderKey(sender, distributionId, record);
  }

  @Override
  public SenderKeyRecord loadSenderKey(REDProtocolAddress sender, UUID distributionId) {
  ...
  public @NonNull REDIdentityKeyStore identities() {
  ...
  public @NonNull REDSenderKeyStore senderKeys() {
