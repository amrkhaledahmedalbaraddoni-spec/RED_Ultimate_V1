...
import com.red.sovereign.attachments.AttachmentMetadata
 ...
 */
class AttachmentMetadataTable(context: Context, databaseHelper: REDDatabase) : DatabaseTable(context, databaseHelper) {
  companion object {
