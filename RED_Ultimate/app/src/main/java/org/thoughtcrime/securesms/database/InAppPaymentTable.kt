...
import com.red.sovereign.util.parcelers.MillisecondDurationParceler
import com.red.sovereign.util.parcelers.NullableSubscriberIdParceler
 ...
 */
class InAppPaymentTable(context: Context, databaseHelper: REDDatabase) : DatabaseTable(context, databaseHelper) {
