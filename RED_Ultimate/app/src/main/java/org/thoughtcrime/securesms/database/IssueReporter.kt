...
import com.red.sovereign.database.model.IssueEntry
 ...
 * threshold ([REDStore.internal] `issueNotificationPriority`) additionally raise a user notification.
...
object IssueReporter {
  ...
  private fun maybeNotify(name: String, priority: IssuePriority) {
    ...
    if (priority.value < REDStore.internal.issueNotificationPriority.value) {
      return
    }
