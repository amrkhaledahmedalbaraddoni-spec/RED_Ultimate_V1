...
import com.red.sovereign.keyvalue.KeyValuePersistentStorage;
...
/**
 * Persists data for the {@link com.red.sovereign.keyvalue.KeyValueStore}.
 *
 * This is it's own separate physical database, so it cannot do joins or queries with any other
 * tables.
 */
public class KeyValueDatabase extends SQLiteOpenHelper implements REDDatabaseOpenHelper, KeyValuePersistentStorage {
