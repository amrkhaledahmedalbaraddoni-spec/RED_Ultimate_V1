 ...
 */
class MessageSendLogTables constructor(context: Context?, databaseHelper: REDDatabase?) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun dropAfterMessageDeleteTrigger() {
    check(REDDatabase.inTransaction)
