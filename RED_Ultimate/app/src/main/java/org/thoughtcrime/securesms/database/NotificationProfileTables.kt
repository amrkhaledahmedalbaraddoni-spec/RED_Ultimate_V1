...
import com.red.sovereign.storage.StorageSyncModels.toLocal
 ...
 */
class NotificationProfileTables(context: Context, databaseHelper: REDDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun insertNotificationProfileFromStorageSync(notificationProfileRecord: REDNotificationProfileRecord) {
  ...
  fun updateNotificationProfileFromStorageSync(notificationProfileRecord: REDNotificationProfileRecord) {
    val profile = notificationProfileRecord.proto
