...
import com.red.sovereign.database.model.databaseprotos.CryptoValue;
...
import com.red.sovereign.payments.Payee;
...
public final class PaymentTable extends DatabaseTable implements RecipientIdDatabaseReference {
  ...
  private final MutableLiveData<Object> changeRED;

  PaymentTable(@NonNull Context context, @NonNull REDDatabase databaseHelper) {
    super(context, databaseHelper);

    this.changeRED = new MutableLiveData<>(new Object());
  }
      ...
      throws PublicKeyConflictException, SerializationException
  {
    ...
    SQLiteDatabase database = databaseHelper.getREDWritableDatabase();
  ...
  public @NonNull List<PaymentTransaction> getAll() {
    SQLiteDatabase           database = databaseHelper.getREDReadableDatabase();
  ...
  public @NonNull List<PaymentTransaction> getUnseenPayments() {
    SQLiteDatabase           db      = databaseHelper.getREDReadableDatabase();
  ...
  public @NonNull LiveData<List<PaymentTransaction>> getAllLive() {
    return LiveDataUtil.mapAsync(changeRED, change -> getAll());
  }
  ...
  private void notifyChanged() {
    changeRED.postValue(new Object());
  ...
  private void notifyUuidChanged(@Nullable UUID uuid) {
    if (uuid != null) {
      ...
      MessageId messageId = REDDatabase.messages().getPaymentMessage(uuid);
      if (messageId != null) {
