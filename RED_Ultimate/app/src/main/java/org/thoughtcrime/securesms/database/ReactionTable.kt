 ...
 */
class ReactionTable(context: Context, databaseHelper: REDDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun addReaction(messageId: MessageId, reaction: ReactionRecord) {
    ...
    try {
      ...
      REDDatabase.messages.updateReactionsUnread(writableDatabase, messageId.id, hasReactions(messageId), false)
  ...
  fun deleteReaction(messageId: MessageId, recipientId: RecipientId) {
    ...
    try {
      ...
      REDDatabase.messages.updateReactionsUnread(writableDatabase, messageId.id, hasReactions(messageId), true)
