...
import com.red.sovereign.database.RemappedRecordTables.SharedColumns.ID
import com.red.sovereign.database.RemappedRecordTables.SharedColumns.NEW_ID
import com.red.sovereign.database.RemappedRecordTables.SharedColumns.OLD_ID
import com.red.sovereign.recipients.RecipientId

/**
 * The backing datastore for [RemappedRecords]. See that class for more details.
 */
class RemappedRecordTables internal constructor(context: Context?, databaseHelper: REDDatabase?) : DatabaseTable(context, databaseHelper) {
