...
import com.red.sovereign.jobs.RebuildMessageSearchIndexJob
...
class SearchTable(context: Context, databaseHelper: REDDatabase) : DatabaseTable(context, databaseHelper) {
  companion object {
  ...
  fun queryMessages(query: String, filter: com.red.sovereign.search.SearchFilter): Cursor? {
    if (filter.isEmpty) {
