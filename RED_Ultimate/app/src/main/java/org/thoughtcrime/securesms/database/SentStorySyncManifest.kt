...
data class SentStorySyncManifest(
  ...
  fun toRecipientsSet(): Set<REDServiceStoryMessageRecipient> {
    ...
    return recipients
      ...
      .map { recipient ->
        ...
        REDServiceStoryMessageRecipient(
          REDServiceAddress(serviceId),
  ...
  companion object {
    @WorkerThread
    @JvmStatic
    fun fromRecipientsSet(recipientsSet: Set<REDServiceStoryMessageRecipient>): SentStorySyncManifest {
