...
class StickerTables(
   ...
   */
  fun insertStickerPackFromStorageSync(record: REDStickerPackRecord) {
   ...
   */
  fun updateStickerPackFromStorageSync(record: REDStickerPackRecord) {
    applyStickerPackFromStorageSync(record)
  }
  ...
  private fun applyStickerPackFromStorageSync(record: REDStickerPackRecord) {
