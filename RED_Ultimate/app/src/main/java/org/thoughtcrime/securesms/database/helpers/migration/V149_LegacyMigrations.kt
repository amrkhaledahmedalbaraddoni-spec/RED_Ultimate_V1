...
import com.red.sovereign.contacts.avatars.ContactColorsLegacy
import com.red.sovereign.conversation.colors.AvatarColor
import com.red.sovereign.conversation.colors.ChatColors
import com.red.sovereign.conversation.colors.ChatColorsMapper
...
import com.red.sovereign.database.model.databaseprotos.ReactionList
 ...
 */
@Suppress("ClassName")
object V149_LegacyMigrations : REDDatabaseMigration {

  private val TAG: String = REDDatabaseMigrations.TAG
    ...
    if (oldVersion < NOTIFICATION_CHANNELS && !SqlUtil.columnExists(db, "recipient_preferences", "notification_channel")) {
      ...
      db.rawQuery("SELECT recipient_ids, system_display_name, signal_profile_name, notification, vibrate FROM recipient_preferences WHERE notification NOT NULL OR vibrate != 0", null).use { cursor ->
        while (cursor != null && cursor.moveToNext()) {
          ...
          val address: String = REDE164Util.formatAsE164(rawAddress) ?: ""
          ...
          val vibrateEnabled: Boolean = if (vibrateState == 0) REDStore.settings.isMessageVibrateEnabled else vibrateState == 1
