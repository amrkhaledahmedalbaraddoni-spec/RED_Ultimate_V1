 ...
 */
@Suppress("ClassName")
object V162_ThreadUnreadSelfMentionCountFixup : REDDatabaseMigration {

  override fun migrate(context: Application, db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
    if (columnMissing(db, "thread", "unread_self_mention_count")) {
      Log.i(REDDatabaseMigrations.TAG, "Fixing up thread table and unread_self_mention_count column")
