...
import com.red.sovereign.database.model.databaseprotos.CustomAvatar
import com.red.sovereign.groups.GroupId

/**
 * Database which manages the record keeping for custom created avatars.
 */
class AvatarPickerDatabase(context: Context, databaseHelper: REDDatabase) : DatabaseTable(context, databaseHelper) {
