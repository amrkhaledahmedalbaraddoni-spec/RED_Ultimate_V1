...
class WebRtcViewModel(state: WebRtcServiceState) {
  ...
  val activeDevice: REDAudioManager.AudioDevice = state.localDeviceState.activeDevice
  val availableDevices: Set<REDAudioManager.AudioDevice> = state.localDeviceState.availableDevices
