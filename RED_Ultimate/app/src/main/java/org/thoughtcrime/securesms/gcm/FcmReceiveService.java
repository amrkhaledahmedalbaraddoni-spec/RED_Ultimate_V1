...
import com.red.sovereign.jobs.SubmitRateLimitPushChallengeJob;
...
public class FcmReceiveService extends FirebaseMessagingService {
  ...
  public void onMessageReceived(RemoteMessage remoteMessage) {
    Log.i(TAG, String.format(Locale.US,
                             ...
                             REDStore.misc().getLastKnownServerTimeOffset(),
    ...
    } else if (verificationCodeRequest != null && REDStore.account().isPrimaryDevice()) {
  ...
  private static void handleVerificationCodeRequested(String verificationCodeRequestJson, long sentTime) {
    ...
    REDStore.account().setVerificationCodeRequestedAtMs(requestedAt);
  }
}