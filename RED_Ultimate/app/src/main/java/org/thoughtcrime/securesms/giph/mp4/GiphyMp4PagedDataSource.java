...
import com.red.sovereign.giph.model.GiphyResponse;
import com.red.sovereign.net.ContentProxySelector;
...
final class GiphyMp4PagedDataSource implements PagedDataSource<String, GiphyImage> {
  ...
  private static final Uri BASE_GIPHY_URI = Uri.parse("https://red.local/giphy/v1/gifs/")
                                               .buildUpon()
  ...
  @Override
  public @NonNull List<GiphyImage> load(int start, int length, int totalSize, @NonNull CancellationRED cancellationRED) {
    try {
