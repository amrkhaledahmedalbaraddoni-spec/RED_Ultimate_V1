...
import com.red.sovereign.groups.ui.GroupMemberOrder;
...
public final class LiveGroup {
  ...
  public LiveGroup(@NonNull GroupId groupId) {
    ...
    this.groupDatabase     = REDDatabase.groups();
    ...
    REDExecutors.BOUNDED.execute(() -> liveRecipient.postValue(Recipient.externalGroupExact(groupId).live()));
  }
