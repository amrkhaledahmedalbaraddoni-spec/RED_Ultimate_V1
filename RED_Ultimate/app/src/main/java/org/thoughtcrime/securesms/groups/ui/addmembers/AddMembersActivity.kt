...
import com.red.sovereign.components.settings.conversation.ConversationSettingsEvent
...
/**
 * Allows members to be added to an existing RED group by selecting from a list of recipients.
 */
