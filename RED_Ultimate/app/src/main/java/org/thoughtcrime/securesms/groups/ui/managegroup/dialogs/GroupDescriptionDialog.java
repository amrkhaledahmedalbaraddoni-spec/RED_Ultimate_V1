package com.red.sovereign.groups.ui.managegroup.dialogs;
...
public final class GroupDescriptionDialog extends DialogFragment {
  ...
  public @NonNull Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
    ...
    MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_RED_MaterialAlertDialog);
