package com.red.sovereign.invites
...
object InviteActions {
  /**
   * Called to send a message to a user to invite them to RED.
   * The invite can be sent in one of three ways:
   *
   * 1. If RED is the user's default SMS app, we can simply append the message to the composer.
