...
import com.red.sovereign.messages.MessageState
...
import org.whispersystems.signalservice.internal.serialize.protos.REDServiceContentProto
...
class PushProcessMessageJobMigration : JobMigration(10) {
  ...
  companion object {
    ...
    private fun migratePushProcessJobWithDecryptedData(jobData: JobData, inputData: JsonJobData): JobData {
      ...
      val proto = REDServiceContentProto.ADAPTER.decode(protoBytes)
