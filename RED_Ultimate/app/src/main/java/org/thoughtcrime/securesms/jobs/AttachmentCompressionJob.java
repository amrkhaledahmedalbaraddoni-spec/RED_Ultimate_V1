...
import com.red.sovereign.video.StreamingTranscoder;
import com.red.sovereign.video.TranscoderOptions;
import com.red.sovereign.video.exceptions.VideoPostProcessingException;
import com.red.sovereign.video.exceptions.VideoSourceException;
import com.red.sovereign.video.interfaces.TranscoderCancelationRED;
import com.red.sovereign.video.postprocessing.Mp4FaststartPostProcessor;
import com.red.sovereign.video.videoconverter.exceptions.CodecUnavailableException;
import com.red.sovereign.video.videoconverter.exceptions.EncodingException;
...
public final class AttachmentCompressionJob extends BaseJob {
  ...
  public void onAdded() {
    ...
    final AttachmentTable    database   = REDDatabase.attachments();
  ...
  public void onRun() throws Exception {
    ...
    AttachmentTable    database           = REDDatabase.attachments();
  ...
  private static @NonNull DatabaseAttachment transcodeVideoIfNeededToDatabase(@NonNull Context context,
                                                                              ...
                                                                              @NonNull TranscoderCancelationRED cancelationRED)
      throws UndeliverableMessageException
  {

    if (cancelationRED.isCanceled()) {
