  ...
  public void onRun() throws IOException {
    ...
    try {
      if (record.isPresent()) {
        ...
        REDServiceAttachmentPointer pointer  = new REDServiceAttachmentPointer(0, new REDServiceAttachmentRemoteId.V2(avatarId), contentType, key, Optional.of(0), Optional.empty(), 0, 0, digest, Optional.empty(), 0, fileName, false, false, false, Optional.empty(), Optional.empty(), System.currentTimeMillis(), null);
        ...
        REDDatabase.groups().onAvatarUpdated(groupId, true);
