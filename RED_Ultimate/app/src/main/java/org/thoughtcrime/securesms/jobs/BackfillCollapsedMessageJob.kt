...
import com.red.sovereign.jobs.BackfillCollapsedMessageJob.Companion.BATCH_SIZE
import com.red.sovereign.jobs.protos.BackfillCollapsedMessageJobData
...
class BackfillCollapsedMessageJob private constructor(
  ...
  override fun run(): Result {
    if (REDStore.misc.completedCollapsedEventsMigration) {
    ...
    if (messageCount == 0 || messageCount != BATCH_SIZE) {
      ...
      REDStore.misc.completedCollapsedEventsMigration = true
    } else {
