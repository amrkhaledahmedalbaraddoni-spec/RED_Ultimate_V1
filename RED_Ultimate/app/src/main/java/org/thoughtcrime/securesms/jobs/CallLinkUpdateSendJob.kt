...
import com.red.sovereign.jobs.protos.CallLinkUpdateSendJobData
...
class CallLinkUpdateSendJob private constructor(
  ...
  override fun onRun() {
    val callLink = REDDatabase.callLinks.getCallLinkByRoomId(callLinkRoomId)
    ...
    AppDependencies.signalServiceMessageSender
      .sendSyncMessage(REDServiceSyncMessage.forCallLinkUpdate(callLinkUpdate))
  }
