...
import com.red.sovereign.jobs.protos.CallSyncEventJobData
import com.red.sovereign.jobs.protos.CallSyncEventJobRecord
import com.red.sovereign.recipients.RecipientId
import com.red.sovereign.ringrtc.RemotePeer
import com.red.sovereign.service.webrtc.CallEventSyncMessageUtil
...
class CallSyncEventJob private constructor(
  ...
  private fun processEvent(callSyncEvent: CallSyncEventJobRecord): CallSyncEventJobRecord? {
    val call = REDDatabase.calls.getCallById(callSyncEvent.callId, callSyncEvent.deserializeRecipientId())
    if (call == null) {
    ...
    return try {
      AppDependencies.signalServiceMessageSender.sendSyncMessage(REDServiceSyncMessage.forCallEvent(syncMessage))
      null
    } catch (e: Exception) {
