...
import com.red.sovereign.service.webrtc.CallingAssets
...
class CallingAssetsDownloadJob private constructor(parameters: Parameters) : Job(parameters) {
  ...
  override fun run(): Result {
    var succeeded = true
    if (REDStore.misc.callingAssetsVersion != CallingAssets.CURRENT_VERSION) {
    ...
    REDStore.misc.callingAssetsVersion = CallingAssets.CURRENT_VERSION
