...
import com.red.sovereign.emoji.EmojiData;
import com.red.sovereign.emoji.EmojiDownloader;
import com.red.sovereign.emoji.EmojiFiles;
import com.red.sovereign.emoji.EmojiImageRequest;
import com.red.sovereign.emoji.EmojiJsonRequest;
import com.red.sovereign.emoji.EmojiPageCache;
import com.red.sovereign.emoji.EmojiRemote;
...
import com.red.sovereign.jobmanager.impl.AutoDownloadEmojiConstraint;
...
public class DownloadLatestEmojiDataJob extends BaseJob {
  ...
  public static void scheduleIfNecessary(@NonNull Context context) {
    long nextScheduledCheck = REDStore.emoji().getNextScheduledImageCheck();
    ...
    if (nextScheduledCheck <= System.currentTimeMillis()) {
      ...
      REDStore.emoji().setNextScheduledImageCheck(System.currentTimeMillis() + interval);
    }
  }
  ...
  private static void clearOldEmojiData(@NonNull Context context, @Nullable EmojiFiles.Version newVersion) {
    ...
    if (version != null) {
      REDStore.emoji().clearJumboEmojiSheets(version.getVersion());
    }
  }
