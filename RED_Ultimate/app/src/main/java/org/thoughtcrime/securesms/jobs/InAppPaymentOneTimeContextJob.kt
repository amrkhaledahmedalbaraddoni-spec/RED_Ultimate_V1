...
import com.red.sovereign.components.settings.app.subscription.InAppPaymentsRepository.toDonationProcessor
  ...
  override fun onRun() {
    ...
    if (serviceResponse.applicationError.isPresent) {
      ...
      if (isCredentialValid(inAppPayment, receiptCredential)) {
        ...
        REDDatabase.donationReceipts.addReceipt(inAppPaymentReceiptRecord)
