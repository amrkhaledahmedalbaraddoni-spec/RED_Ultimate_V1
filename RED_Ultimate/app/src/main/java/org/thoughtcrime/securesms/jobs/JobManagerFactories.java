...
import com.red.sovereign.jobmanager.impl.ChargingAndBatteryIsNotLowConstraintObserver;
import com.red.sovereign.jobmanager.impl.ChargingConstraint;
import com.red.sovereign.jobmanager.impl.DataRestoreConstraint;
import com.red.sovereign.jobmanager.impl.DataRestoreConstraintObserver;
import com.red.sovereign.jobmanager.impl.DecryptionsDrainedConstraint;
import com.red.sovereign.jobmanager.impl.DecryptionsDrainedConstraintObserver;
...
import com.red.sovereign.jobmanager.impl.NetworkConstraintObserver;
...
import com.red.sovereign.jobmanager.impl.NotInCallConstraintObserver;
...
import com.red.sovereign.jobmanager.migrations.DeprecatedJobMigration;
import com.red.sovereign.jobmanager.migrations.DonationReceiptRedemptionJobMigration;
import com.red.sovereign.jobmanager.migrations.GroupCallPeekJobDataMigration;
import com.red.sovereign.jobmanager.migrations.PushDecryptMessageJobEnvelopeMigration;
import com.red.sovereign.jobmanager.migrations.PushProcessMessageJobMigration;
import com.red.sovereign.jobmanager.migrations.RetrieveProfileJobMigration;
import com.red.sovereign.jobmanager.migrations.SendReadReceiptsJobMigration;
import com.red.sovereign.jobmanager.migrations.SenderKeyDistributionSendJobRecipientMigration;
import com.red.sovereign.migrations.AccountConsistencyMigrationJob;
import com.red.sovereign.migrations.AccountRecordMigrationJob;
import com.red.sovereign.migrations.AepMigrationJob;
import com.red.sovereign.migrations.ApplyUnknownFieldsToSelfMigrationJob;
import com.red.sovereign.migrations.ArchiveBackupIdReservationMigrationJob;
import com.red.sovereign.migrations.AttachmentCleanupMigrationJob;
import com.red.sovereign.migrations.AttachmentHashBackfillMigrationJob;
import com.red.sovereign.migrations.AttributesMigrationJob;
import com.red.sovereign.migrations.AvatarColorStorageServiceMigrationJob;
import com.red.sovereign.migrations.AvatarIdRemovalMigrationJob;
import com.red.sovereign.migrations.AvatarMigrationJob;
import com.red.sovereign.migrations.BackfillCollapsedEventsMigrationJob;
import com.red.sovereign.migrations.BackfillDigestsForDuplicatesMigrationJob;
import com.red.sovereign.migrations.BackfillNotifiedStateMigrationJob;
import com.red.sovereign.migrations.BackupJitterMigrationJob;
import com.red.sovereign.migrations.BackupNotificationMigrationJob;
import com.red.sovereign.migrations.BadE164MigrationJob;
import com.red.sovereign.migrations.BlobStorageLocationMigrationJob;
import com.red.sovereign.migrations.CachedAttachmentsMigrationJob;
import com.red.sovereign.migrations.ClearGlideCacheMigrationJob;
import com.red.sovereign.migrations.ContactLinkRebuildMigrationJob;
import com.red.sovereign.migrations.CopyUsernameToREDStoreMigrationJob;
import com.red.sovereign.migrations.DatabaseMigrationJob;
import com.red.sovereign.migrations.DeleteDeprecatedLogsMigrationJob;
import com.red.sovereign.migrations.DirectoryRefreshMigrationJob;
import com.red.sovereign.migrations.DuplicateE164MigrationJob;
import com.red.sovereign.migrations.E164FormattingMigrationJob;
import com.red.sovereign.migrations.EmojiDownloadMigrationJob;
import com.red.sovereign.migrations.EmojiSearchEnglishLabelsMigrationJob;
import com.red.sovereign.migrations.EmojiSearchIndexCheckMigrationJob;
import com.red.sovereign.migrations.FixChangeNumberErrorMigrationJob;
import com.red.sovereign.migrations.GooglePlayBillingPurchaseTokenMigrationJob;
import com.red.sovereign.migrations.GroupDeletedBackfillMigrationJob;
import com.red.sovereign.migrations.IdentityTableCleanupMigrationJob;
import com.red.sovereign.migrations.KeyTransparencyUsernameMigrationJob;
import com.red.sovereign.migrations.LegacyMigrationJob;
import com.red.sovereign.migrations.LocalArchiveReconciliationMigrationJob;
import com.red.sovereign.migrations.MigrationCompleteJob;
import com.red.sovereign.migrations.OptimizeMessageSearchIndexMigrationJob;
import com.red.sovereign.migrations.PassingMigrationJob;
import com.red.sovereign.migrations.PinOptOutMigration;
import com.red.sovereign.migrations.PinReminderMigrationJob;
import com.red.sovereign.migrations.PniAccountInitializationMigrationJob;
import com.red.sovereign.migrations.PniMigrationJob;
import com.red.sovereign.migrations.PnpLaunchMigrationJob;
import com.red.sovereign.migrations.PreKeysSyncMigrationJob;
import com.red.sovereign.migrations.ProfileMigrationJob;
import com.red.sovereign.migrations.ProfileSharingUpdateMigrationJob;
import com.red.sovereign.migrations.QuoteThumbnailBackfillMigrationJob;
import com.red.sovereign.migrations.RebuildMessageSearchIndexMigrationJob;
import com.red.sovereign.migrations.RecheckPaymentsMigrationJob;
import com.red.sovereign.migrations.RecipientSearchMigrationJob;
import com.red.sovereign.migrations.ReleaseChannelRecipientFixMigrationJob;
import com.red.sovereign.migrations.ResetArchiveTierMigrationJob;
import com.red.sovereign.migrations.ResetKeyTransparencyMigrationJob;
import com.red.sovereign.migrations.SelfRegisteredStateMigrationJob;
import com.red.sovereign.migrations.StickerAdditionMigrationJob;
import com.red.sovereign.migrations.StickerDayByDayMigrationJob;
import com.red.sovereign.migrations.StickerLaunchMigrationJob;
import com.red.sovereign.migrations.StickerMyDailyLifeMigrationJob;
import com.red.sovereign.migrations.StickerPackAddition2MigrationJob;
import com.red.sovereign.migrations.StorageCapabilityMigrationJob;
import com.red.sovereign.migrations.StorageFixLocalUnknownMigrationJob;
import com.red.sovereign.migrations.StorageServiceMigrationJob;
import com.red.sovereign.migrations.StorageServiceSystemNameMigrationJob;
import com.red.sovereign.migrations.StoryViewedReceiptsStateMigrationJob;
import com.red.sovereign.migrations.SubscriberIdMigrationJob;
import com.red.sovereign.migrations.Svr2MirrorMigrationJob;
import com.red.sovereign.migrations.SyncCallLinksMigrationJob;
import com.red.sovereign.migrations.SyncChatFoldersMigrationJob;
import com.red.sovereign.migrations.SyncDistributionListsMigrationJob;
import com.red.sovereign.migrations.SyncKeysMigrationJob;
import com.red.sovereign.migrations.SyncStickerPacksMigrationJob;
import com.red.sovereign.migrations.TrimByLengthSettingsMigrationJob;
import com.red.sovereign.migrations.UpdateSmsJobsMigrationJob;
import com.red.sovereign.migrations.UserNotificationMigrationJob;
import com.red.sovereign.migrations.UuidMigrationJob;
import com.red.sovereign.migrations.WallpaperCleanupMigrationJob;
import com.red.sovereign.migrations.WallpaperStorageMigrationJob;
...
public final class JobManagerFactories {
  ...
  public static Map<String, Job.Factory> getJobFactories(@NonNull Application application) {
    return new HashMap<>() {{
      ...
      put(CopyUsernameToREDStoreMigrationJob.KEY,      new CopyUsernameToREDStoreMigrationJob.Factory());
  ...
  public static List<JobMigration> getJobMigrations(@NonNull Application application) {
    return Arrays.asList(new DeprecatedJobMigration(2),
                         ...
                         new SendReadReceiptsJobMigration(REDDatabase.messages()),
