...
import com.red.sovereign.attachments.toAttachmentPointer
...
import com.red.sovereign.jobs.protos.MultiDeviceAttachmentBackfillUpdateJobData
...
class MultiDeviceAttachmentBackfillUpdateJob(
  ...
  override fun run(): Result {
    ...
    val syncMessage = REDServiceSyncMessage.forAttachmentBackfillResponse(
