...
public class MultiDeviceVerifiedUpdateJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException, NoSessionException {
    ...
    try {
      ...
      REDServiceAddress          verifiedAddress = RecipientUtil.toREDServiceAddress(context, recipient);
      ...
      messageSender.sendSyncMessage(REDServiceSyncMessage.forVerified(verifiedMessage)
      );
