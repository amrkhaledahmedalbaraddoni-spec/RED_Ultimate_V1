...
public class MultiDeviceViewOnceOpenJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException, NoSessionException {
    ...
    RecipientRecord            recipient     = REDDatabase.recipients().getRecord(RecipientId.from(messageId.recipientId));
    ...
    messageSender.sendSyncMessage(REDServiceSyncMessage.forViewOnceOpen(openMessage));
  }
