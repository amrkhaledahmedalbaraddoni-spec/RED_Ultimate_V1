...
import com.red.sovereign.jobs.protos.NewLinkedDeviceNotificationJobData
...
class NewLinkedDeviceNotificationJob private constructor(
  ...
  override fun run(): Result {
    ...
    REDStore.misc.newLinkedDeviceId = data.deviceId
    REDStore.misc.newLinkedDeviceCreatedTime = data.deviceCreatedAt
