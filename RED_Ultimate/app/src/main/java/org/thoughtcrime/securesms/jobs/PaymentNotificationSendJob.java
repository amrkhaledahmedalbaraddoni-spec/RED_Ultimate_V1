...
public final class PaymentNotificationSendJob extends BaseJob {
  ...
  protected void onRun() throws Exception {
    ...
    PaymentTable paymentDatabase = REDDatabase.payments();
    ...
    REDServiceAddress       address       = RecipientUtil.toREDServiceAddress(context, recipient);
    ...
    REDServiceDataMessage dataMessage = REDServiceDataMessage.newBuilder()
                                                                   .withPayment(new REDServiceDataMessage.Payment(new REDServiceDataMessage.PaymentNotification(payment.getReceipt(), payment.getNote()), null))
                                                                   .build();
    ...
    if (recipient.getNeedsPniSignature()) {
      REDDatabase.pendingPniSignatureMessages().insertIfNecessary(recipientId, dataMessage.getTimestamp(), sendMessageResult);
    }
