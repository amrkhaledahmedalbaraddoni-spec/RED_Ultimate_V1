...
class PostRegistrationBackupRedemptionJob : CoroutineJob {
  ...
  override suspend fun doRun(): Result {
    ...
    val emptyPrice = FiatMoney(BigDecimal.ZERO, REDStore.inAppPayments.getOneTimeCurrency())
    val price: FiatMoney = if (subscription != null) {
      FiatMoney.fromREDNetworkAmount(subscription.amount, Currency.getInstance(subscription.currency))
