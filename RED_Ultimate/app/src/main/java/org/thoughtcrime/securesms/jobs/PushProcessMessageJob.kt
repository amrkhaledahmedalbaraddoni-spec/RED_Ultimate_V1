...
import com.red.sovereign.jobmanager.impl.ChangeNumberConstraint
import com.red.sovereign.jobmanager.impl.NetworkConstraint
import com.red.sovereign.messages.BatchCache
import com.red.sovereign.messages.MessageContentProcessor
import com.red.sovereign.messages.MessageDecryptor
...
class PushProcessMessageJob private constructor(
  ...
  companion object {
    ...
    fun processOrDefer(messageProcessor: MessageContentProcessor, result: MessageDecryptor.Result.Success, localReceiveMetric: REDLocalMetrics.MessageReceive, batchCache: BatchCache): PushProcessMessageJob? {
