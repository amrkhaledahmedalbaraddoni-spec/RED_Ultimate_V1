...
import com.red.sovereign.jobmanager.Job.Result
...
class ResetSvrGuessCountJob private constructor(
    ...
    SvrRepository.operationLock.withLock {
      ...
      val svr3Result = if (svr3Complete) {
        ...
        resetGuessCount(
          ...
          authTokenSaver = { REDStore.svr.appendSvr3AuthTokenToList(it.asBasic()) }
        )
      }
      ...
      return if (svr2Complete) {
        ...
        resetGuessCount(
          ...
          authTokenSaver = { REDStore.svr.appendSvr2AuthTokenToList(it.asBasic()) }
        )
      }
    }
  }
  ...
  private fun resetGuessCount(
    ...
    val session: PinChangeSession = if (serializedChangeSession != null) {
      svr.resumePinChangeSession(pin, REDStore.svr.masterKey, serializedChangeSession)
    } else {
