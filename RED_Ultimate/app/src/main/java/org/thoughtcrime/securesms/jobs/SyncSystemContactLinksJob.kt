...
/**
 * This job makes sure all of the contact "links" are up-to-date. The links are the actions you see when you look at a RED user in your system contacts
...
class SyncSystemContactLinksJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  override fun onRun() {
    ...
    val e164sForLinking: Set<String> = REDDatabase.recipients.getE164sForSystemContactLinks()
  ...
  companion object {
    ...
    private const val MESSAGE_MIMETYPE = "vnd.android.cursor.item/vnd.com.red.sovereign.contact"
    private const val CALL_MIMETYPE = "vnd.android.cursor.item/vnd.com.red.sovereign.call"
    private const val VIDEO_CALL_MIMETYPE = "vnd.android.cursor.item/vnd.com.red.sovereign.videocall"
    ...
    fun buildContactLinkConfiguration(context: Context, account: Account): ContactLinkConfiguration {
      return ContactLinkConfiguration(
        ...
        e164Formatter = { number -> REDE164Util.formatAsE164(number) },
