...
import com.red.sovereign.keyboard.sticker.KeyboardStickerPackListAdapter.StickerPack
...
class StickerKeyboardPageViewModel(private val repository: StickerKeyboardRepository) : ViewModel() {
  ...
  class Factory : ViewModelProvider.Factory {
    private val repository = StickerKeyboardRepository(REDDatabase.stickers)
