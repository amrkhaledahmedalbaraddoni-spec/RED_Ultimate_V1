...
import com.red.sovereign.jobmanager.impl.BackupMessagesConstraintObserver
...
import com.red.sovereign.jobmanager.impl.RestoreAttachmentConstraintObserver
import com.red.sovereign.keyvalue.protos.ArchiveUploadProgressState
import com.red.sovereign.keyvalue.protos.BackupDownloadNotifierState
...
class BackupValues(store: KeyValueStore) : REDStoreValues(store) {
  companion object {
  ...
  val messageBackupKey: MessageBackupKey
    get() = REDStore.account.accountEntropyPool.deriveMessageBackupKey()
  ...
  /**
   * Denotes if there was a mismatch detected between the user's RED subscription, on-device Google Play subscription,
