...
import com.red.sovereign.database.model.databaseprotos.TemporalAuthCredentialResponse;
import com.red.sovereign.database.model.databaseprotos.TemporalAuthCredentialResponses;
...
public final class GroupsV2AuthorizationREDStoreCache implements GroupsV2Authorization.ValueCache {

  private static final String TAG = Log.tag(GroupsV2AuthorizationREDStoreCache.class);
  ...
  public static GroupsV2AuthorizationREDStoreCache createAciCache(@NonNull KeyValueStore store) {
    ...
    return new GroupsV2AuthorizationREDStoreCache(store, ACI_PNI_PREFIX + ":" + ACI_PNI_VERSION);
  }

  private GroupsV2AuthorizationREDStoreCache(@NonNull KeyValueStore store, @NonNull String key) {
    this.store           = store;
    this.key             = key;
