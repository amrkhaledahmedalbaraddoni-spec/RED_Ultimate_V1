 ...
 */
public final class PinValues extends REDStoreValues {
  ...
  public void onEntrySuccess(@NonNull String pin) {
    long nextInterval = REDPinReminders.getNextInterval(getCurrentInterval());
    ...
    REDStore.svr().setPinIfNotPresent(pin);
  }

  public void onEntrySuccessWithWrongGuess(@NonNull String pin) {
    long nextInterval = REDPinReminders.getPreviousInterval(getCurrentInterval());
  ...
  public void onEntrySkip(boolean includedFailure) {
    ...
    if (includedFailure) {
      nextInterval = REDPinReminders.getPreviousInterval(getCurrentInterval());
    } else {
  ...
  public void resetPinReminders() {
    long nextInterval = REDPinReminders.INITIAL_INTERVAL;
  ...
  public @NonNull PinKeyboardType getKeyboardType() {
    String pin = REDStore.svr().getPin();
