...
public final class ProxyValues extends REDStoreValues {
  ...
  public void enableProxy(@NonNull REDProxy proxy) {
   ...
   */
  public void setProxy(@Nullable REDProxy proxy) {
    if (proxy != null) {
      getStore().beginWrite()
                .putString(KEY_HOST, proxy.getHost())
                .putInteger(KEY_PORT, proxy.getPort())
