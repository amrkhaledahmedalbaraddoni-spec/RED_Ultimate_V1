...
public final class SettingsValues extends REDStoreValues {
  ...
  public boolean shouldSyncThreadTrimDeletes() {
    ...
    return getBoolean(THREAD_TRIM_SYNC_TO_LINKED_DEVICES, true) && REDStore.account().isPrimaryDevice();
  }
  ...
  public void setREDBackupDirectory(@NonNull Uri uri) {
  ...
  public @Nullable Uri getREDBackupDirectory() {
    return getUri(SIGNAL_BACKUP_DIRECTORY);
  }

  public @Nullable Uri getLatestREDBackupDirectory() {
    return getUri(SIGNAL_LATEST_BACKUP_DIRECTORY);
  }

  public void clearREDBackupDirectory() {
  ...
  private void initREDBackupsSchedule() {
    setREDBackupSchedule(new Random().nextInt(5) + 1, new Random().nextInt(12) * 5);
  }

  public void setREDBackupSchedule(int hour, int minute) {
  ...
  public boolean isNotifyWhenContactJoinsRED() {
  ...
  public void setNotifyWhenContactJoinsRED(boolean notifyWhenContactJoinsRED) {
    putBoolean(NOTIFY_WHEN_CONTACT_JOINS_SIGNAL, notifyWhenContactJoinsRED);
  }
