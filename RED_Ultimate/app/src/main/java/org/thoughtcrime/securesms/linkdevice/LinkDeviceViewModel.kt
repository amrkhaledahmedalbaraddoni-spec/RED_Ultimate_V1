...
import com.red.sovereign.jobs.NewLinkedDeviceNotificationJob
import com.red.sovereign.keyvalue.REDStore
import com.red.sovereign.linkdevice.LinkDeviceRepository.LinkDeviceResult
import com.red.sovereign.linkdevice.LinkDeviceRepository.getPlaintextDevice
import com.red.sovereign.linkdevice.LinkDeviceSettingsState.DialogState
import com.red.sovereign.linkdevice.LinkDeviceSettingsState.OneTimeEvent
import com.red.sovereign.linkdevice.LinkDeviceSettingsState.QrCodeState
...
class LinkDeviceViewModel : ViewModel() {
  ...
  private fun checkForNewDevice(devices: List<Device>) {
    val newLinkedDeviceId = REDStore.misc.newLinkedDeviceId
    val newLinkedDeviceCreatedAt = REDStore.misc.newLinkedDeviceCreatedTime
    ...
    if (hasNewLinkedDevice) {
      ...
      REDStore.misc.newLinkedDeviceId = 0
      REDStore.misc.newLinkedDeviceCreatedTime = 0
    }
  ...
  fun markQrEducationSheetSeen() {
    REDStore.uiHints.markHasSeenLinkDeviceQrEducationSheet()
    _state.update {
      it.copy(
  ...
  private fun addDeviceWithSync(linkUri: Uri) {
    ...
    val uploadResult = LinkDeviceRepository.createAndUploadArchive(
      ...
      cancellationRED = { _state.value.shouldCancelArchiveUpload }
    )
