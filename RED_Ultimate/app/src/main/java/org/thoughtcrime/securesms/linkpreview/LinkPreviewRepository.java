...
import com.red.sovereign.linkpreview.LinkPreviewUtil.OpenGraph;
import com.red.sovereign.mms.PushMediaConstraints;
import com.red.sovereign.net.CallRequestController;
import com.red.sovereign.net.CompositeRequestController;
import com.red.sovereign.net.LinkPreviewRedirectValidationInterceptor;
import com.red.sovereign.net.RequestController;
import com.red.sovereign.net.UserAgentInterceptor;
...
import com.red.sovereign.util.OkHttpUtil;
...
public class LinkPreviewRepository {
  ...
  {
    if (!REDStore.settings().isLinkPreviewsEnabled()) {
  ...
  private static RequestController fetchCallLinkPreview(@NonNull Context context,
    ...
    Disposable disposable = AppDependencies.getREDCallManager()
                                           .getCallLinkManager()
                                                         ...
                                                         @NonNull Callback callback)
  {
    REDExecutors.UNBOUNDED.execute(() -> {
      try {
        ...
        Optional<GroupRecord> group   = REDDatabase.groups().getGroup(groupId);
