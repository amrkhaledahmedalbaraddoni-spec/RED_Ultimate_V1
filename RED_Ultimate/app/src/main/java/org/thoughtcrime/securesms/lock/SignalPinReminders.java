package com.red.sovereign.lock;
...
/**
 * Reminder intervals for RED PINs.
 */
public class REDPinReminders {

  private static final String TAG = Log.tag(REDPinReminders.class);
  ...
  private static final Map<Long, Integer> STRINGS = new HashMap<Long, Integer>() {{
    put(ONE_DAY, R.string.REDPinReminders_well_remind_you_again_tomorrow);
    put(THREE_DAYS, R.string.REDPinReminders_well_remind_you_again_in_a_few_days);
    put(ONE_WEEK, R.string.REDPinReminders_well_remind_you_again_in_a_week);
    put(TWO_WEEKS, R.string.REDPinReminders_well_remind_you_again_in_a_couple_weeks);
    put(FOUR_WEEKS, R.string.REDPinReminders_well_remind_you_again_in_a_month);
  }};

  private static final Map<Long, Integer> SKIP_STRINGS = new HashMap<Long, Integer>() {{
    put(ONE_DAY, R.string.REDPinReminders__well_remind_you_again_tomorrow);
    put(THREE_DAYS, R.string.REDPinReminders__well_remind_you_again_in_a_few_days);
    put(ONE_WEEK, R.string.REDPinReminders__well_remind_you_again_in_a_week);
    put(TWO_WEEKS, R.string.REDPinReminders__well_remind_you_again_in_a_couple_weeks);
    put(FOUR_WEEKS, R.string.REDPinReminders__well_remind_you_again_in_a_month);
  }};
  ...
  public static @StringRes int getReminderString(long interval) {
    ...
    if (stringRes != null) {
      ...
      return R.string.REDPinReminders_well_remind_you_again_later;
    }
  }
  ...
  public static @StringRes int getSkipReminderString(long interval) {
    ...
    if (stringRes != null) {
      ...
      Log.w(TAG, "Couldn't find a string for interval " + interval);
      return R.string.REDPinReminders__well_remind_you_again_later;
    }
  }
}
