...
import com.red.sovereign.util.BucketInfo
import com.red.sovereign.util.DeviceProperties
import com.red.sovereign.util.WakeLockUtil
import java.util.Locale
import kotlin.time.Duration.Companion.milliseconds

/**
 * A point-in-time summary of process resource usage relevant to battery consumption. The detailed
 * time series lives in the regular logs (emitted by [com.red.sovereign.util.BatterySnapshotTracker]);
