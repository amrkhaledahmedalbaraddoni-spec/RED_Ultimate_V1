...
final class LogSectionNotifications implements LogSection {
  ...
  public @NonNull CharSequence getContent(@NonNull Context context) {
    ...
    output.append("Message notifications: ").append(REDStore.settings().isMessageNotificationsEnabled()).append("\n")
          .append("Call notifications   : ").append(REDStore.settings().isCallNotificationsEnabled()).append("\n")
          .append("New contact alerts   : ").append(REDStore.settings().isNotifyWhenContactJoinsRED()).append("\n")
          .append("In-chat sounds       : ").append(REDStore.settings().isMessageNotificationsInChatSoundsEnabled()).append("\n")
          .append("Repeat alerts        : ").append(REDStore.settings().getMessageNotificationsRepeatAlerts()).append("\n")
          .append("Notification display : ").append(REDStore.settings().getMessageNotificationsPrivacy()).append("\n")
          .append("Force websocket      : ").append(REDStore.settings().getForceWebsocketMode()).append("\n\n");
