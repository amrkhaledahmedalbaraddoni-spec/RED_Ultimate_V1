...
import com.red.sovereign.components.ProgressCard;
import com.red.sovereign.components.SearchView;
...
public class SubmitDebugLogActivity extends BaseActivity {
  ...
  private void onFilterLevel(View view, boolean isChecked) {
    ...
    if (isUncaught) selectedLevels.add("\" REDUncaughtException:\"");
    ...
    AlertDialog.Builder builder = new MaterialAlertDialogBuilder(this)
        ...
        .setPositiveButton(R.string.SubmitDebugLogActivity_share, (d, w) -> {
          ShareCompat.IntentBuilder.from(this)
                                   .setText(url)
                                   .setType("text/plain")
                                   .setEmailTo(new String[] { "support@red.local" })
                                   .startChooser();
        });
