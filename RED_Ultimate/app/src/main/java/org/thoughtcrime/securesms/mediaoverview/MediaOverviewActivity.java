...
import com.red.sovereign.components.BoldSelectionTabItem;
import com.red.sovereign.components.ControllableTabLayout;
...
public final class MediaOverviewActivity extends PassphraseRequiredActivity {
  ...
  private void initializeToolbar() {
    ...
    if (threadId == MediaTable.ALL_THREADS) {
      ...
      SimpleTask.run(() -> REDDatabase.threads().getRecipientForThreadId(threadId),
        (recipient) -> {
          if (recipient != null) {
