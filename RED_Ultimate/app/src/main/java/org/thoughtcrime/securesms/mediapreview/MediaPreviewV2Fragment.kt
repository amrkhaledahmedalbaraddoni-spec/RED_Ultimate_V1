package com.red.sovereign.mediapreview
...
import com.red.sovereign.databinding.FragmentMediaPreviewV2Binding
import com.red.sovereign.dependencies.AppDependencies
import com.red.sovereign.keyvalue.REDStore
import com.red.sovereign.mediapreview.caption.ExpandingCaptionView
import com.red.sovereign.mediapreview.mediarail.CenterDecoration
import com.red.sovereign.mediapreview.mediarail.MediaRailAdapter
import com.red.sovereign.mediapreview.mediarail.MediaRailAdapter.ImageLoadingListener
...
import com.red.sovereign.util.OffloadedMediaDialogUtil
import com.red.sovereign.util.SaveAttachmentUtil
...
class MediaPreviewV2Fragment :
  ...
  private fun initializeToolbar(toolbar: MaterialToolbar) {
    ...
    toolbar.setTitleTextAppearance(requireContext(), CoreUiR.style.RED_Text_TitleMedium)
    toolbar.setSubtitleTextAppearance(requireContext(), CoreUiR.style.RED_Text_BodyMedium)
  ...
  private fun saveToDisk(mediaItem: MediaTable.MediaRecord) {
    ...
    if (attachment != null && !attachment.hasData && REDStore.backup.optimizeStorage) {
  ...
  private fun deleteMedia(mediaItem: MediaTable.MediaRecord) {
    ...
    val messageRecord = REDDatabase.messages.getMessageRecord(attachment.mmsId)
  ...
  private fun canRemotelyDelete(attachment: DatabaseAttachment, messageRecord: MessageRecord): Boolean {
    ...
    val attachmentCount = REDDatabase.attachments.getAttachmentsForMessage(mmsId).size
