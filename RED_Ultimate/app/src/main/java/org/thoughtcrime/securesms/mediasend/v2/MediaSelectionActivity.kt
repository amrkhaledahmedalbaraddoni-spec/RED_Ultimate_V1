...
import com.red.sovereign.mediasend.v2.review.MediaReviewFragment
import com.red.sovereign.mediasend.v2.text.TextStoryPostCreationViewModel
...
class MediaSelectionActivity :
  ...
  override fun onSendError(error: Throwable) {
    ...
    // SIGNAL_INHERITED: TODO [alex] - Toast
  ...
  companion object {
    ...
    private fun buildIntent(
      context: Context,
      startAction: Int = -1,
      messageSendType: MessageSendType = MessageSendType.REDMessageSendType,
