...
import com.red.sovereign.databinding.V2MediaGalleryFragmentBinding
import com.red.sovereign.mediasend.MediaRepository
import com.red.sovereign.mediasend.v2.review.MediaGalleryGridItemTouchListener
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    galleryItemsWithSelection.observe(viewLifecycleOwner) {
      if (StorageUtil.canOnlyReadSelectedMediaStore() && it.isEmpty()) {
        ...
        binding.mediaGalleryMissingPermissions.visible = true
        binding.mediaGalleryManageContainer.visible = false
        binding.mediaGalleryPermissionText.text = getString(R.string.AttachmentKeyboard_RED_needs_permission_to_show_your_photos_and_videos)
