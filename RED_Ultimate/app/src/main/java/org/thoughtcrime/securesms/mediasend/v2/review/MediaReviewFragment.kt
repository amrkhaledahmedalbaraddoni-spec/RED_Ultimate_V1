...
import com.red.sovereign.media.DecryptableUriMediaInput
import com.red.sovereign.mediasend.MediaSendActivityResult
import com.red.sovereign.mediasend.v2.HudCommand
import com.red.sovereign.mediasend.v2.MediaAnimations
import com.red.sovereign.mediasend.v2.MediaSelectionNavigator
import com.red.sovereign.mediasend.v2.MediaSelectionState
import com.red.sovereign.mediasend.v2.MediaSelectionViewModel
import com.red.sovereign.mediasend.v2.UntrustedRecords
import com.red.sovereign.mediasend.v2.stories.StoriesMultiselectForwardActivity
...
import com.red.sovereign.video.TranscodingQuality
...
class MediaReviewFragment : Fragment(R.layout.v2_media_review_fragment), ScheduleMessageTimePickerBottomSheet.ScheduleCallback, ScheduleMessageDialogCallback, VideoThumbnailsRangeSelectorView.RangeDragListener, SafetyNumberBottomSheet.Callbacks {
  ...
  private var sentMediaQuality: SentMediaQuality = REDStore.settings.sentMediaQuality
  ...
  private fun presentSendButton(enabled: Boolean, sendType: MessageSendType, recipient: Recipient?) {
    val sendButtonBackgroundTint = when {
      ...
      sendType.usesREDTransport -> ContextCompat.getColor(requireContext(), CoreUiR.color.signal_colorOnSecondaryContainer)
