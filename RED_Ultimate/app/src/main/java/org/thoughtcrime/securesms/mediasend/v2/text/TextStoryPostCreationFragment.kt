package com.red.sovereign.mediasend.v2.text
...
import com.red.sovereign.databinding.StoriesTextPostCreationFragmentBinding
import com.red.sovereign.linkpreview.LinkPreview
import com.red.sovereign.linkpreview.LinkPreviewState
...
import com.red.sovereign.mediasend.v2.text.send.TextStoryPostSendRepository
import com.red.sovereign.mediasend.v2.text.send.TextStoryPostSendResult
...
class TextStoryPostCreationFragment : Fragment(R.layout.stories_text_post_creation_fragment), TextStoryPostTextEntryFragment.Callback, SafetyNumberBottomSheet.Callbacks {
  ...
  private fun initializeTextStoryBar() {
    ...
    val composeView = ComposeView(requireContext()).apply {
      ...
      setContent {
        REDTheme {
          val background = textStoryBackground ?: return@REDTheme
          if (isSmallScreen) {
