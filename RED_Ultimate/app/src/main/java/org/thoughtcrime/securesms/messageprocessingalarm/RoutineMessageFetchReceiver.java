package com.red.sovereign.messageprocessingalarm;
...
public final class RoutineMessageFetchReceiver extends BroadcastReceiver {
  ...
  public static final String BROADCAST_ACTION = "com.red.sovereign.action.PROCESS_MESSAGES";
