...
object REDServiceProtoUtil {
  ...
  fun AttachmentPointer.toPointer(stickerLocator: StickerLocator? = null): Attachment? {
    return try {
      val pointer = PointerAttachment.forPointer(Optional.of(toREDServiceAttachmentPointer()), stickerLocator).orNull()
  ...
  fun AttachmentPointer.toREDServiceAttachmentPointer(): REDServiceAttachmentPointer {
    return AttachmentPointerUtil.createREDAttachmentPointer(this)
  }
