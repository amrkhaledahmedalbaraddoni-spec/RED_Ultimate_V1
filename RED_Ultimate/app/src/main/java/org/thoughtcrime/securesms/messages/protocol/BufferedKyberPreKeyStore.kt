...
import com.red.sovereign.database.KyberPreKeyTable.KyberPreKey
 ...
 */
class BufferedKyberPreKeyStore(private val selfServiceId: ServiceId) : REDServiceKyberPreKeyStore {
  ...
  override fun loadKyberPreKey(kyberPreKeyId: Int): KyberPreKeyRecord {
    return store.computeIfAbsent(kyberPreKeyId) {
      REDDatabase.kyberPreKeys.get(selfServiceId, kyberPreKeyId) ?: throw InvalidKeyIdException("Missing kyber prekey with ID: $kyberPreKeyId")
    }.record
  }
  ...
  override fun loadKyberPreKeys(): List<KyberPreKeyRecord> {
    return if (hasLoadedAll) {
      ...
      val models = REDDatabase.kyberPreKeys.getAll(selfServiceId)
