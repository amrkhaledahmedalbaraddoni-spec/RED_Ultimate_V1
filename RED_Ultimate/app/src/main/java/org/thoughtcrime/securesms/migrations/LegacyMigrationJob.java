...
import com.red.sovereign.database.MessageTable.MmsReader;
...
//      REDDatabase.recipients().updateSystemContactColors();
...
//    }
  ...
  private void schedulePendingIncomingParts(Context context) {
    final AttachmentTable          attachmentDb       = REDDatabase.attachments();
    final MessageTable             mmsDb              = REDDatabase.messages();
    final List<DatabaseAttachment> pendingAttachments = REDDatabase.attachments().getPendingAttachments();
