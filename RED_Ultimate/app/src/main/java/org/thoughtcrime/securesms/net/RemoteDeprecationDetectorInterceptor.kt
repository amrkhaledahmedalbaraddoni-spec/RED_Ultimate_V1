...
import com.red.sovereign.keyvalue.REDStore.Companion.misc
import java.io.IOException

/**
 * Marks the client as remotely-deprecated when it receives a 499 response.
 */
class RemoteDeprecationDetectorInterceptor(private val getConfiguration: () -> REDServiceConfiguration) : Interceptor {
