...
import com.red.sovereign.notifications.v2.DefaultMessageNotifier;
import com.red.sovereign.notifications.v2.ConversationId;
import com.red.sovereign.recipients.Recipient;
import com.red.sovereign.util.BubbleUtil;
import com.red.sovereign.util.LeakyBucketLimiter;
...
public class OptimizedMessageNotifier implements MessageNotifier {
  ...
  public OptimizedMessageNotifier(@NonNull Application context) {
    this.limiter                = new LeakyBucketLimiter(3, 1000, new Handler(REDExecutors.getAndStartHandlerThread("signal-notifier", ThreadUtil.PRIORITY_IMPORTANT_BACKGROUND_THREAD).getLooper()));
  ...
  public void updateNotification(@NonNull Context context) {
    REDDatabase.runPostSuccessfulTransaction(DEDUPE_KEY_GENERAL, () -> {
  ...
  public void updateNotification(@NonNull Context context, @NonNull ConversationId conversationId) {
    REDDatabase.runPostSuccessfulTransaction(DEDUPE_KEY_CHAT + conversationId.getThreadId(), () -> {
