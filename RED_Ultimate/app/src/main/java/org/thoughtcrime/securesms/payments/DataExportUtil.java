...
public final class DataExportUtil {
  ...
  public static @NonNull String createTsv() {
    ...
    List<PaymentTable.PaymentTransaction> paymentTransactions = REDDatabase.payments().getAll();
    MobileCoinLedgerWrapper               ledger              = REDStore.payments().liveMobileCoinLedger().getValue();
