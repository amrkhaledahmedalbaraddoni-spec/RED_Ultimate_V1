...
public final class Wallet {
  ...
  public @NonNull Balance getCachedBalance() {
    return REDStore.payments().mobileCoinLatestBalance();
  }

  @WorkerThread
  public @NonNull MobileCoinLedgerWrapper getCachedLedger() {
    return REDStore.payments().mobileCoinLatestFullLedger();
  }
    ...
    try {
      ...
      builder.spentTxos(spentTxos)
             ...
             .highestBlock(new MobileCoinLedger.Block.Builder()
                                                     ...
                                                     .build());
      REDStore.payments().setEnclaveFailure(false);
      ...
      REDStore.payments().setEnclaveFailure(true);
