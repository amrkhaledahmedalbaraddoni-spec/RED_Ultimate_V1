package com.red.sovereign.payments.backup.confirm;
...
public class PaymentsRecoveryPhraseConfirmFragment extends Fragment {
  ...
  public static final  String   REQUEST_KEY_RECOVERY_PHRASE = "com.red.sovereign.payments.backup.confirm.RECOVERY_PHRASE";
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    seePhraseAgain.setOnClickListener(v -> Navigation.findNavController(requireView()).popBackStack());
      ...
      REDStore.payments().confirmMnemonic(true);
