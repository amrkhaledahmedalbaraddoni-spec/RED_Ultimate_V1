package com.red.sovereign.payments.confirm;
...
import com.red.sovereign.database.PaymentTable.PaymentTransaction;
import com.red.sovereign.dependencies.AppDependencies;
import com.red.sovereign.keyvalue.REDStore;
import com.red.sovereign.payments.CreatePaymentDetails;
import com.red.sovereign.payments.FiatMoneyUtil;
import com.red.sovereign.payments.PaymentTransactionLiveData;
import com.red.sovereign.payments.PaymentsAddressException;
import com.red.sovereign.payments.confirm.ConfirmPaymentRepository.ConfirmPaymentResult;
import com.red.sovereign.util.DefaultValueLiveData;
...
final class ConfirmPaymentViewModel extends ViewModel {
                          ...
                          @NonNull ConfirmPaymentRepository confirmPaymentRepository)
  {
    ...
    this.store.update(REDStore.payments().liveMobileCoinBalance(), (balance, state) -> state.updateBalance(balance.getFullAmount()));
    ...
    LiveData<ConfirmPaymentState.Status> timeoutRED  = Transformations.switchMap(statusLiveData,
                                                                                    s -> {
    ...
    this.store.update(timeoutRED, this::handleTimeout);
  }
