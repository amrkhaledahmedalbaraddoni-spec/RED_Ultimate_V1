...
import com.red.sovereign.keyvalue.PaymentsAvailability;
...
import com.red.sovereign.payments.UnreadPaymentsRepository;
...
public class PaymentsHomeViewModel extends ViewModel {
                        ...
                        @NonNull CurrencyExchangeRepository currencyExchangeRepository)
  {
    ...
    this.balance                    = LiveDataUtil.mapDistinct(REDStore.payments().liveMobileCoinBalance(), Balance::getFullAmount);
    ...
    LiveData<CurrencyExchange.ExchangeRate> liveExchangeRate = LiveDataUtil.combineLatest(REDStore.payments().liveCurrentCurrency(),
  ...
  private static PaymentsHomeState.PaymentsState getPaymentsState() {
    PaymentsValues paymentsValues = REDStore.payments();
  ...
  void checkPaymentActivationState() {
    ...
    boolean                         paymentsEnabled = REDStore.payments().mobileCoinPaymentsEnabled();
