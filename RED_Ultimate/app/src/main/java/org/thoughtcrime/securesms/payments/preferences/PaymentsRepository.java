...
import com.red.sovereign.payments.reconciliation.LedgerReconcile;
...
public class PaymentsRepository {
  ...
  public PaymentsRepository() {
    paymentDatabase = REDDatabase.payments();

    LiveData<List<PaymentTable.PaymentTransaction>> localPayments = paymentDatabase.getAllLive();
    LiveData<MobileCoinLedgerWrapper>               ledger        = REDStore.payments().liveMobileCoinLedger();
