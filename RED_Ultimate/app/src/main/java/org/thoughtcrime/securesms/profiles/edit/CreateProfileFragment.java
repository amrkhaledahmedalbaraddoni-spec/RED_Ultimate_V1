...
import com.red.sovereign.databinding.CreateProfileFragmentBinding;
import com.red.sovereign.dependencies.AppDependencies;
import com.red.sovereign.groups.GroupId;
import com.red.sovereign.keyvalue.PhoneNumberPrivacyValues;
import com.red.sovereign.keyvalue.REDStore;
import com.red.sovereign.profiles.edit.pnp.WhoCanFindMeByPhoneNumberFragment;
import com.red.sovereign.profiles.manage.EditProfileNameFragment;
...
import com.red.sovereign.util.text.AfterTextChanged;

import java.io.IOException;
import java.io.InputStream;

import static com.red.sovereign.profiles.edit.CreateProfileActivity.EXCLUDE_SYSTEM;
import static com.red.sovereign.profiles.edit.CreateProfileActivity.GROUP_ID;
import static com.red.sovereign.profiles.edit.CreateProfileActivity.IS_DESCRIPTION_FOCUSED;
import static com.red.sovereign.profiles.edit.CreateProfileActivity.NEXT_BUTTON_TEXT;
import static com.red.sovereign.profiles.edit.CreateProfileActivity.NEXT_INTENT;
import static com.red.sovereign.profiles.edit.CreateProfileActivity.SHOW_TOOLBAR;
    ...
    if (isEditingGroup) {
      ...
      getParentFragmentManager().setFragmentResultListener(WhoCanFindMeByPhoneNumberFragment.REQUEST_KEY, getViewLifecycleOwner(), (requestKey, result) -> {
        if (WhoCanFindMeByPhoneNumberFragment.REQUEST_KEY.equals(requestKey)) {
          presentWhoCanFindMeDescription(REDStore.phoneNumberPrivacy().getPhoneNumberDiscoverabilityMode());
        }
      });
