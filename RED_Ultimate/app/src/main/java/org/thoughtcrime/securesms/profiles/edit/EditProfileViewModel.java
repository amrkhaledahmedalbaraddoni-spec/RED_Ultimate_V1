...
import com.red.sovereign.profiles.edit.EditProfileRepository.UploadResult;
...
class EditProfileViewModel extends ViewModel {
  ...
  public void submitProfile() {
    ...
    REDExecutors.BOUNDED.execute(() -> {
      if (!isGroup && REDStore.phoneNumberPrivacy().getPhoneNumberDiscoverabilityMode() == PhoneNumberDiscoverabilityMode.UNDECIDED) {
