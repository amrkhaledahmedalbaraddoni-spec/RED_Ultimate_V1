...
import com.red.sovereign.profiles.ProfileMediaConstraints;
import com.red.sovereign.profiles.ProfileName;
import com.red.sovereign.profiles.SystemProfileUtil;
...
public class EditSelfProfileRepository implements EditProfileRepository {
  ...
  public void getCurrentUsername(@NonNull Consumer<Optional<String>> callback) {
    callback.accept(Optional.ofNullable(REDStore.account().getUsername()));
  }
}
