...
import com.red.sovereign.avatar.Avatars.getForegroundColor
import com.red.sovereign.avatar.Avatars.getTextSizeForLength
import com.red.sovereign.avatar.picker.AvatarPickerFragment
import com.red.sovereign.badges.models.Badge
import com.red.sovereign.badges.self.none.BecomeASustainerFragment.Companion.show
import com.red.sovereign.components.emoji.EmojiUtil
import com.red.sovereign.databinding.EditProfileFragmentBinding
import com.red.sovereign.keyvalue.AccountValues
import com.red.sovereign.keyvalue.REDStore
import com.red.sovereign.profiles.ProfileName
import com.red.sovereign.profiles.manage.EditProfileViewModel.AvatarState
...
import com.red.sovereign.util.NameUtil.getAbbreviation
...
class EditProfileFragment : LoggingFragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    binding.manageProfileUsernameContainer.setOnClickListener { v: View ->
      if (!viewModel.isRegisteredAndUpToDate) {
        onClickWhenUnregisteredOrDeprecated()
      } else if (REDStore.account.username != null) {
        MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_RED_MaterialAlertDialog_List)
  ...
  private fun presentUsername(username: String?) {
    ...
    if (REDStore.account.usernameSyncState == AccountValues.UsernameSyncState.USERNAME_AND_LINK_CORRUPTED) {
      binding.usernameErrorIndicator.visibility = View.VISIBLE
    } else {
      binding.usernameErrorIndicator.visibility = View.GONE
    }

    if (REDStore.account.username != null && REDStore.account.usernameSyncState != AccountValues.UsernameSyncState.USERNAME_AND_LINK_CORRUPTED) {
      ...
      if (REDStore.tooltips.showProfileSettingsQrCodeTooltop()) {
        ...
        binding.linkTooltipCloseButton.setOnClickListener {
          ...
          REDStore.tooltips.markProfileSettingsQrCodeTooltipSeen()
        }
      }
  ...
  private fun displayConfirmUsernameDeletionDialog() {
    MaterialAlertDialogBuilder(requireContext())
      ...
      .setMessage(requireContext().getString(R.string.ManageProfileFragment__delete_username_dialog_body, REDStore.account.username))
