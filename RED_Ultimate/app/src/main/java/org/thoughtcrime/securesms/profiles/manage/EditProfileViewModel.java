...
class EditProfileViewModel extends ViewModel {
  ...
  public boolean isRegisteredAndUpToDate() {
    return !TextSecurePreferences.isUnauthorizedReceived(AppDependencies.getApplication()) && REDStore.account().isRegistered() && !REDStore.misc().isClientDeprecated();
  }
  ...
  private void onRecipientChanged(@NonNull Recipient recipient) {
    ...
    username.postValue(REDStore.account().getUsername());
