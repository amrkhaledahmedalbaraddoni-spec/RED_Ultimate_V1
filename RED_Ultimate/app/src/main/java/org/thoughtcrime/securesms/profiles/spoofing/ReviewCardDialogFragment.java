...
import com.red.sovereign.components.FullScreenDialogFragment;
...
public class ReviewCardDialogFragment extends FullScreenDialogFragment {
  ...
  private final class AdapterCallbacks implements ReviewCardAdapter.Callbacks {
    ...
    @Override
    public void onREDConnectionClicked() {
      new REDConnectionsBottomSheetDialogFragment().show(getParentFragmentManager(), BottomSheetUtil.STANDARD_BOTTOM_SHEET_FRAGMENT_TAG);
    }
  }
}
