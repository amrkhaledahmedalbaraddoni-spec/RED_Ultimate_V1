...
import com.red.sovereign.recipients.ui.RecipientPicker.DisplayMode.Companion.flag
import com.red.sovereign.recipients.ui.RecipientPicker.KeyboardType
...
private fun ContactSelectionListFragment.setUpCallbacks(
  ...
  if (callbacks.newConversation != null) {
    fragment.setNewConversationCallback(object : ContactSelectionListFragment.NewConversationCallback {
      override fun onInvite() = callbacks.newConversation.onInviteToRED()
  ...
  if (callbacks.newCall != null) {
    fragment.setNewCallCallback { callbacks.newCall.onInviteToRED() }
  } else {
...
private suspend fun showItemContextMenu(
  ...
  REDContextMenu.Builder(anchorView, anchorView.getRootView() as ViewGroup)
    .preferredVerticalPosition(REDContextMenu.VerticalPosition.BELOW)
    .preferredHorizontalPosition(REDContextMenu.HorizontalPosition.START)
...
object RecipientPicker {
  /**
   * Enum wrapper for [com.red.sovereign.contacts.ContactSelectionDisplayMode].
   */
