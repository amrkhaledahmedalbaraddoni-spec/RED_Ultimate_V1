...
import com.red.sovereign.recipients.ui.sharablegrouplink.qr.GroupLinkShareQrDialogFragment;
...
public final class GroupLinkBottomSheetDialogFragment extends BottomSheetDialogFragment {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    setStyle(DialogFragment.STYLE_NORMAL,
             ThemeUtil.isDarkTheme(requireContext()) ? R.style.Theme_RED_RoundedBottomSheet
                                                     : R.style.Theme_RED_RoundedBottomSheet_Light);
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    View     shareViaREDButton = view.findViewById(R.id.group_link_bottom_sheet_share_via_signal_button);
    ...
    liveGroup.getGroupLink().observe(getViewLifecycleOwner(), groupLink -> {
      ...
      shareViaREDButton.setOnClickListener(v -> {
