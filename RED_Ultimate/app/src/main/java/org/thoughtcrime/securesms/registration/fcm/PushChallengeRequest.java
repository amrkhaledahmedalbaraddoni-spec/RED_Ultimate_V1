...
package com.red.sovereign.registration.fcm;
...
public final class PushChallengeRequest {
   ...
   */
  @WorkerThread
  public static Optional<String> getPushChallengeBlocking(@NonNull REDServiceAccountManager accountManager,
  ...
  public static class Request {
    ...
    private final REDServiceAccountManager accountManager;
    private final String                      fcmToken;
    private final String                      sessionId;
    private final long                        timeoutMs;

    private Request(@NonNull REDServiceAccountManager accountManager,
