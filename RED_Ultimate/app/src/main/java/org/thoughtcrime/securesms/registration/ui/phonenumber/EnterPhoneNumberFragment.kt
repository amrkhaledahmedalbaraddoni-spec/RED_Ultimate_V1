...
package com.red.sovereign.registration.ui.phonenumber
...
import com.red.sovereign.databinding.FragmentRegistrationEnterPhoneNumberBinding
...
import com.red.sovereign.registration.fragments.RegistrationViewDelegate.setDebugLogSubmitMultiTapView
import com.red.sovereign.registration.ui.RegistrationCheckpoint
import com.red.sovereign.registration.ui.RegistrationState
...
import com.red.sovereign.registration.ui.countrycode.CountryCodeFragment
import com.red.sovereign.registration.ui.toE164
import com.red.sovereign.registration.util.CountryPrefix
...
import com.red.sovereign.util.livedata.LiveDataObserverCallback
...
class EnterPhoneNumberFragment : LoggingFragment(R.layout.fragment_registration_enter_phone_number) {
  ...
  private fun presentConfirmNumberDialog(phoneNumber: PhoneNumber, isReRegister: Boolean, canSkipSms: Boolean, missingFcmConsentRequired: Boolean) {
    ...
    val message: CharSequence = SpannableStringBuilder().apply {
      append(SpanUtil.bold(REDE164Util.prettyPrint(phoneNumber.toE164())))
      if (!canSkipSms) {
        append("\n\n")
