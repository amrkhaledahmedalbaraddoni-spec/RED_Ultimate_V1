...
/**
 * Shown when the old device is iOS and they are trying to transfer/restore on Android without a RED Backup.
 */
...
private fun NoBackupToRestoreContent(
  ...
  RegistrationScreen(
    ...
    Column(
      ...
      StepRow(icon = REDIcons.Backup.painter, text = stringResource(id = R.string.NoBackupToRestore_step2))

      StepRow(icon = REDIcons.CheckCircle.painter, text = stringResource(id = R.string.NoBackupToRestore_step3))
    }
