...
import com.red.sovereign.RestoreDirections
import com.red.sovereign.keyvalue.REDStore
import com.red.sovereign.keyvalue.isWantingManualRemoteRestore
import com.red.sovereign.keyvalue.isWantingNewLocalBackupRestore
    ...
    when (navTarget) {
      NavTarget.NEW_LANDING -> {
        if (sharedViewModel.hasNoRestoreMethods()) {
          if (REDStore.registration.restoreDecisionState.isWantingManualRemoteRestore) {
          ...
          } else if (REDStore.registration.restoreDecisionState.isWantingNewLocalBackupRestore && Environment.Backups.isNewFormatSupportedForLocalBackup()) {
