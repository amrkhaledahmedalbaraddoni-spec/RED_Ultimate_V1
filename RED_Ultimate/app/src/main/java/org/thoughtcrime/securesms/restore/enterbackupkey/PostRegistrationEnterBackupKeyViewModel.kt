...
package com.red.sovereign.restore.enterbackupkey
...
import com.red.sovereign.registration.ui.restore.AccountEntropyPoolVerification.AEPValidationError
  ...
  fun restoreBackupTimestamp() {
    ...
    viewModelScope.launch(Dispatchers.IO) {
      ...
      val restoreTimestampResult = if (aep != null) {
        BackupRepository.verifyBackupKeyAssociatedWithAccount(REDStore.account.requireAci(), aep)
      } else {
