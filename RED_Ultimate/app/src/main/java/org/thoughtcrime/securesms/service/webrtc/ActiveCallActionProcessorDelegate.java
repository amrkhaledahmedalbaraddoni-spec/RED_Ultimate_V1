...
import com.red.sovereign.webrtc.audio.OutgoingRinger;
...
import static com.red.sovereign.webrtc.CallNotificationBuilder.TYPE_INCOMING_CONNECTING;
...
public class ActiveCallActionProcessorDelegate extends WebRtcActionProcessor {
  ...
  protected @NonNull WebRtcServiceState handleLocalHangup(@NonNull WebRtcServiceState currentState) {
    ...
    AppDependencies.getREDServiceAccountManager().cancelInFlightRequests();
    AppDependencies.getREDServiceMessageSender().cancelInFlightRequests();
                                                          ...
                                                          @NonNull RemotePeer remotePeer)
  {
    ...
    if (callEndReason == CallEndReason.REMOTE_HANGUP || callEndReason == CallEndReason.REMOTE_HANGUP_BUSY) {
      ...
      ThreadUtil.runOnMainDelayed(ringer::stop, REDCallManager.BUSY_TONE_LENGTH);
