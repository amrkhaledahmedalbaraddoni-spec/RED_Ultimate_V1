...
import com.red.sovereign.webrtc.UncaughtExceptionHandlerManager
import com.red.sovereign.webrtc.audio.AudioManagerCommand
import com.red.sovereign.webrtc.audio.REDAudioManager
import com.red.sovereign.webrtc.audio.REDAudioManager.Companion.create
import com.red.sovereign.webrtc.locks.LockManager
import java.util.concurrent.locks.ReentrantLock
import kotlin.concurrent.withLock

/**
 * Entry point for [REDCallManager] and friends to interact with the Android system.
 *
...
class ActiveCallManager(
  ...
  private var signalAudioManager: REDAudioManager? = null
  ...
  override fun onAudioDeviceChanged(activeDevice: REDAudioManager.AudioDevice, devices: Set<REDAudioManager.AudioDevice>) {
    ...
    private class HangUpRtcOnPstnCallAnsweredListener : PhoneStateListener() {
      ...
      override fun onCallStateChanged(state: Int, phoneNumber: String) {
        ...
        if (state == TelephonyManager.CALL_STATE_OFFHOOK) {
          hangup()
          Log.i(TAG, "Device phone call ended RED call.")
        }
      }
  ...
  class ActiveCallServiceReceiver : BroadcastReceiver() {
    ...
    companion object {
      const val ACTION_DENY = "com.red.sovereign.service.webrtc.ActiveCallAction.DENY"
      const val ACTION_HANGUP = "com.red.sovereign.service.webrtc.ActiveCallAction.HANGUP"
    }
