...
import com.red.sovereign.components.webrtc.GroupCallSafetyNumberChangeNotificationUtil;
...
import com.red.sovereign.ringrtc.CallState;
...
import com.red.sovereign.service.webrtc.WebRtcData.CallMetadata;
import com.red.sovereign.service.webrtc.WebRtcData.OfferMetadata;
import com.red.sovereign.service.webrtc.WebRtcData.ReceivedOfferMetadata;
...
import com.red.sovereign.service.webrtc.state.WebRtcServiceStateBuilder;
import org.signal.core.util.AppForegroundObserver;
import com.red.sovereign.util.NetworkUtil;
import com.red.sovereign.util.TelephonyUtil;
...
import static com.red.sovereign.service.webrtc.WebRtcData.AnswerMetadata;
import static com.red.sovereign.service.webrtc.WebRtcData.HangupMetadata;
import static com.red.sovereign.service.webrtc.WebRtcData.ReceivedAnswerMetadata;
 ...
 * <p>
 * Processing of the actions occur in by calls from {@link REDCallManager} and
...
public abstract class WebRtcActionProcessor {
  ...
  protected final @NonNull WebRtcServiceState handleSendOffer(@NonNull WebRtcServiceState currentState, @NonNull CallMetadata callMetadata, @NonNull OfferMetadata offerMetadata, boolean broadcast) {
    ...
    REDServiceCallMessage callMessage         = REDServiceCallMessage.forOffer(offerMessage, destinationDeviceId);
                                                                  ...
                                                                  @NonNull ReceivedOfferMetadata receivedOfferMetadata)
  {
    ...
    NotificationProfile activeProfile = NotificationProfiles.getActiveProfile(REDDatabase.notificationProfiles().getProfiles());
                                                                     ...
                                                                     @NonNull ReceivedOfferMetadata receivedOfferMetadata)
  {
    ...
    try {
      ...
      byte[] localIdentityKey  = WebRtcUtil.getPublicKeyBytes(REDStore.account().getAciIdentityKey().getPublicKey().serialize());
                                                         ...
                                                         boolean broadcast)
  {
    ...
    Integer       destinationDeviceId    = broadcast ? null : callMetadata.getRemoteDevice();
    REDServiceCallMessage callMessage = REDServiceCallMessage.forAnswer(answerMessage, destinationDeviceId);
  ...
  protected final @NonNull WebRtcServiceState handleSendBusy(@NonNull WebRtcServiceState currentState, @NonNull CallMetadata callMetadata, boolean broadcast) {
    ...
    Integer                  destinationDeviceId = broadcast ? null : callMetadata.getRemoteDevice();
    REDServiceCallMessage callMessage         = REDServiceCallMessage.forBusy(busyMessage, destinationDeviceId);
                                                               ...
                                                               boolean broadcast)
  {
    ...
    Integer                  destinationDeviceId = broadcast ? null : callMetadata.getRemoteDevice();
    REDServiceCallMessage callMessage         = REDServiceCallMessage.forHangup(hangupMessage, destinationDeviceId);
  ...
  protected @NonNull WebRtcServiceState handleAudioDeviceChanged(@NonNull WebRtcServiceState currentState, @NonNull REDAudioManager.AudioDevice activeDevice, @NonNull Set<REDAudioManager.AudioDevice> availableDevices) {
  ...
  protected @NonNull WebRtcServiceState handleSetUserAudioDevice(@NonNull WebRtcServiceState currentState, @NonNull REDAudioManager.ChosenAudioDeviceIdentifier userDevice) {
  ...
  protected final @NonNull WebRtcServiceState handleSendIceCandidates(@NonNull WebRtcServiceState currentState, @NonNull CallMetadata callMetadata, boolean broadcast, @NonNull List<byte[]> iceCandidates) {
    ...
    Integer                  destinationDeviceId = broadcast ? null : callMetadata.getRemoteDevice();
    REDServiceCallMessage callMessage         = REDServiceCallMessage.forIceUpdates(iceUpdateMessages, destinationDeviceId);
                                                                  ...
                                                                  @NonNull RingUpdate ringUpdate)
  {
    ...
    try {
      ...
      REDDatabase.calls().insertOrUpdateGroupCallFromRingState(ringId,
