...
import com.red.sovereign.service.webrtc.WebRtcActionProcessor;
...
public class WebRtcServiceStateBuilder {
  ...
  public class LocalDeviceStateBuilder {
    ...
    public @NonNull LocalDeviceStateBuilder setActiveDevice(@NonNull REDAudioManager.AudioDevice audioDevice) {
      toBuild.setActiveDevice(audioDevice);
      return this;
    }

    public @NonNull LocalDeviceStateBuilder setAvailableDevices(@NonNull Set<REDAudioManager.AudioDevice> availableDevices) {
