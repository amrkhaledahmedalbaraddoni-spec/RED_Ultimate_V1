package com.red.sovereign.sharing.v2
...
import com.red.sovereign.mediasend.v2.MediaSelectionActivity.Companion.share
import com.red.sovereign.recipients.RecipientId
import com.red.sovereign.sharing.MultiShareDialogs
import com.red.sovereign.sharing.MultiShareSender
import com.red.sovereign.sharing.MultiShareSender.MultiShareSendResultCollection
import com.red.sovereign.sharing.interstitial.ShareInterstitialActivity
...
class ShareActivity : PassphraseRequiredActivity(), MultiselectForwardFragment.Callback {
  ...
  override fun onCreate(savedInstanceState: Bundle?, ready: Boolean) {
    ...
    var dialog: REDProgressDialog? = null
    viewModel
      .state
      ...
      .subscribeBy { state ->
        if (state.loadState == ShareState.ShareDataLoadState.Init) {
          dialog = REDProgressDialog.show(this, indeterminate = true)
        } else {
          dialog?.dismiss()
          dialog = null
        }
  ...
  private fun openMediaInterstitial(shareEvent: ShareEvent.OpenMediaInterstitial) {
    ...
    val intent = share(
      this,
      MessageSendType.REDMessageSendType,
      media,
