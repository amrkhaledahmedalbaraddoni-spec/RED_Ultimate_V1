...
package com.red.sovereign.stickers.manage
...
import com.red.sovereign.components.compose.RoundCheckbox
import com.red.sovereign.components.transfercontrols.TransferProgressIndicator
import com.red.sovereign.components.transfercontrols.TransferProgressState
import com.red.sovereign.stickers.StickerPreviewDataFactory
import com.red.sovereign.stickers.manage.AvailableStickerPack.DownloadStatus
...
fun AvailableStickerPackRow(
  ...
  Row(
    ...
    DropdownMenus.Menu(
      ...
      offsetX = 0.dp,
      offsetY = 12.dp,
      modifier = modifier.background(REDTheme.colors.colorSurface2)
    ) {
      MenuItem(
      ...
      MenuItem(
        icon = REDIcons.Forward.imageVector,
...
fun InstalledStickerPackRow(
  ...
  Row(
    ...
    modifier = modifier
      .padding(horizontal = 16.dp)
      .background(
        color = if (selected) REDTheme.colors.colorSurface2 else MaterialTheme.colorScheme.surface,
        shape = RoundedCornerShape(18.dp)
      )
    ...
    DropdownMenus.Menu(
      ...
      MenuItem(
        icon = REDIcons.CheckCircle.imageVector,
      ...
      MenuItem(
        icon = REDIcons.Trash.imageVector,
