 ...
 */
abstract class DefaultStorageRecordProcessor<E : REDRecord<*>> : StorageRecordProcessor<E>, Comparator<E> {
  companion object {
   ...
   * general we rely on REDRecords to implement an equals() that includes the StorageId, so using
