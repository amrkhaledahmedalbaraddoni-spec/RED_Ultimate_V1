package com.red.sovereign.stories.dialogs
...
import com.red.sovereign.stories.landing.StoriesLandingItem
import com.red.sovereign.stories.viewer.page.StoryPost
import com.red.sovereign.stories.viewer.page.StoryViewerPageState
...
object StoryContextMenu {
  ...
  fun delete(context: Context, record: MessageRecord): Single<Boolean> {
    ...
    val isGroupTerminated = recipient.isPushV2Group && !REDDatabase.groups.isActive(recipient.requireGroupId())
