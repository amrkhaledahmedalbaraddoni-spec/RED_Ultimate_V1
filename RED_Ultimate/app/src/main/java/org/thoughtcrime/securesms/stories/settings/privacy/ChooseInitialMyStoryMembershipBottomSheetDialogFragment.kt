...
import com.red.sovereign.stories.settings.connections.ViewAllREDConnectionsFragment
...
class ChooseInitialMyStoryMembershipBottomSheetDialogFragment :
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    allView.setOnClickListener {
      ViewAllREDConnectionsFragment.Dialog.show(parentFragmentManager)
    }
    ...
    lifecycleDisposable += viewModel.state
      .subscribe { state ->
        ...
        allCount.visible = state.allREDConnectionsCount > 0
        allCount.text = resources.getQuantityString(R.plurals.MyStorySettingsFragment__viewers, state.allREDConnectionsCount, state.allREDConnectionsCount)
