...
import com.red.sovereign.stories.viewer.first.StoryFirstTimeNavigationFragment
import com.red.sovereign.stories.viewer.page.StoryViewerPageArgs
import com.red.sovereign.stories.viewer.page.StoryViewerPageFragment
import com.red.sovereign.stories.viewer.reply.StoriesSharedElementCrossFaderView
...
class StoryViewerFragment :
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    if (savedInstanceState != null && savedInstanceState.containsKey(HIDDEN)) {
      ...
      if (!REDStore.story.userHasSeenFirstNavView && !REDStore.story.userHasViewedOnboardingStory) {
