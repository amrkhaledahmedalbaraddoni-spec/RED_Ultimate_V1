package com.red.sovereign.stories.viewer.first
...
import com.red.sovereign.stories.StoryFirstTimeNavigationView
import com.red.sovereign.stories.viewer.StoryViewerState
...
class StoryFirstTimeNavigationFragment : DialogFragment(R.layout.story_viewer_first_time_navigation_stub), StoryFirstTimeNavigationView.Callback {
  ...
  override fun userHasSeenFirstNavigationView(): Boolean {
    return REDStore.story.userHasSeenFirstNavView
  }

  override fun onGotItClicked() {
    dismissAllowingStateLoss()

    REDStore.story.userHasSeenFirstNavView = true
