...
import com.red.sovereign.keyboard.emoji.EmojiKeyboardCallback
...
import com.red.sovereign.stories.viewer.reply.composer.StoryReplyComposer
...
class StoryGroupReplyFragment :
  ...
  private fun onTapForDetailsClick(messageRecord: MessageRecord) {
    if (messageRecord.isRemoteDelete) {
      // SIGNAL_INHERITED: TODO [cody] Android doesn't support resending remote deletes yet
      return
    }
    ...
    if (messageRecord.isIdentityMismatchFailure) {
      ...
      MaterialAlertDialogBuilder(requireContext())
        ...
        .setPositiveButton(R.string.conversation_activity__send) { _, _ -> REDExecutors.BOUNDED.execute { MessageSender.resend(requireContext(), messageRecord) } }
        .show()
    }
  }
