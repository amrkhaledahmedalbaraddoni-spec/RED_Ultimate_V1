...
import com.red.sovereign.notifications.v2.NotificationFactory;
...
public final class BubbleUtil {
  ...
  public static boolean canBubble(@NonNull Context context, @NonNull Recipient recipient, @Nullable Long threadId) {
    ...
    NotificationPrivacyPreference privacyPreference = REDStore.settings().getMessageNotificationsPrivacy();
