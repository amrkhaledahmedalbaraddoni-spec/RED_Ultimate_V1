...
import com.red.sovereign.components.settings.app.appearance.appicon.util.AppIconUtility;
...
public final class ConversationUtil {
  ...
  private static final String CATEGORY_SHARE_TARGET = "com.red.sovereign.sharing.CATEGORY_SHARE_TARGET";
                                                               ...
                                                               @NonNull Direction direction)
  {
    ...
    long      threadId   = REDDatabase.threads().getOrCreateThreadIdFor(resolved);
  ...
  private static @NonNull Person[] buildPersonsForGroup(@NonNull Context context, @NonNull GroupId groupId) {
    List<Recipient> members = REDDatabase.groups().getGroupMembers(groupId, GroupTable.MemberSet.FULL_MEMBERS_EXCLUDING_SELF);
