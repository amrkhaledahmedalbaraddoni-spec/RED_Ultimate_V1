...
/**
 * @deprecated Use a base activity that uses the {@link com.red.sovereign.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
public class DynamicLanguage {
  ...
  private static Locale getSelectedLocale(Context context) {
    Locale locale = LanguageString.parseLocale(REDStore.settings().getLanguage());
    if (locale == null) {
      return Locale.getDefault();
    } else {
      return locale;
