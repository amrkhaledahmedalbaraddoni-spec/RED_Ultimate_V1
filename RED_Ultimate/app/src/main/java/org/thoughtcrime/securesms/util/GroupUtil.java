...
import com.red.sovereign.messages.REDServiceProtoUtil;
...
public final class GroupUtil {
  ...
  public static @Nullable GroupContextV2 getGroupContextIfPresent(@NonNull Content content) {
    if (content.dataMessage != null && REDServiceProtoUtil.INSTANCE.getHasGroupContext(content.dataMessage)) {
      return content.dataMessage.groupV2;
               ...
               REDServiceProtoUtil.INSTANCE.getHasGroupContext(content.syncMessage.sent.message))
    {
      return content.syncMessage.sent.message.groupV2;
    } else if (content.storyMessage != null && REDServiceProtoUtil.INSTANCE.isValid(content.storyMessage.group)) {
  ...
  public static void setDataMessageGroupContext(@NonNull Context context,
                                                @NonNull REDServiceDataMessage.Builder dataMessageBuilder,
      ...
      throws UndeliverableMessageException
  {
    if (groupId.isV2()) {
      ...
      REDServiceGroupV2            group             = REDServiceGroupV2.newBuilder(v2GroupProperties.getGroupMasterKey())
