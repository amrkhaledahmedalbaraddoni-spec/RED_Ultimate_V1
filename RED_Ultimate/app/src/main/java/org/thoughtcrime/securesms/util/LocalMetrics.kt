...
import com.red.sovereign.database.model.LocalMetricsEvent
import com.red.sovereign.database.model.LocalMetricsSplit
...
object LocalMetrics {
  ...
  private val executor: Executor = REDExecutors.newCachedSingleThreadExecutor("signal-LocalMetrics", ThreadUtil.PRIORITY_BACKGROUND_THREAD)
