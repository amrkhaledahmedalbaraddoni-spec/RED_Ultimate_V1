...
import com.red.sovereign.lock.RegistrationLockReminders;
...
public class TextSecurePreferences {
  ...
  public static void onPostBackupRestore(@NonNull Context context) {
    if (NotificationChannels.supported()) {
      NotificationChannels.getInstance().updateMessageVibrate(REDStore.settings().isMessageVibrateEnabled());
    }
  }
  ...
  /**
   * @deprecated Use {@link SettingsValues#getMessageFontSize()} via {@link com.red.sovereign.keyvalue.REDStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getTheme()} via {@link com.red.sovereign.keyvalue.REDStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getLanguage()} via {@link com.red.sovereign.keyvalue.REDStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#setLanguage(String)} via {@link com.red.sovereign.keyvalue.REDStore} instead.
   */
  @Deprecated
  ...
  private static void clearLocalCredentials(Context context) {
    ...
    REDDatabase.recipients().setProfileKey(self.getId(), newProfileKey);
  ...
  private static void notifyUnregisteredReceived(Context context) {
    ...
    Intent registrationIntent = REDStore.account().isLinkedDevice() ? RegistrationActivity.newIntentForReLinkDevice(context)
