 ...
 */
 ...
 public class REDDataSource implements DataSource {
  ...
  public REDDataSource(@NonNull DefaultDataSource defaultDataSource,
  ...
  public static final class Factory implements DataSource.Factory {
    ...
    @Override
    public @NonNull REDDataSource createDataSource() {
      return new REDDataSource(new DefaultDataSourceFactory(context, "GenericUserAgent", null).createDataSource(),
