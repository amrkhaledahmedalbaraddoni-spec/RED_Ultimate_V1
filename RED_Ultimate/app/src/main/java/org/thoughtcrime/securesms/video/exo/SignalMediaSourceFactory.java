package com.red.sovereign.video.exo;
...
/**
 * This class is responsible for creating a MediaSource object for a given Uri, using {@link REDDataSource.Factory}.
 */
@OptIn(markerClass = UnstableApi.class)
public final class REDMediaSourceFactory implements MediaSource.Factory {

  private final ProgressiveMediaSource.Factory progressiveMediaSourceFactory;

  public REDMediaSourceFactory(@NonNull Context context) {
    DataSource.Factory attachmentDataSourceFactory = new REDDataSource.Factory(context, null, ExoPlayerPool.DataSourceTransferListener.INSTANCE);
