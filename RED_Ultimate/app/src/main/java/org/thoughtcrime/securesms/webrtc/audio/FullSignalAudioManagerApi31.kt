 ...
 * and the previous REDAudioManager implementation would have required us to ask for (poorly labeled & scary) Bluetooth permissions.
 */
@RequiresApi(31)
class FullREDAudioManagerApi31(context: Context, eventListener: EventListener?) : REDAudioManager(context, eventListener) {
  private val TAG = "REDAudioManager31"
