...
/**
 * Lightweight [REDAudioManager] used when Jetpack Core Telecom is managing the call.
 *
 ...
 *
 * Device availability and active device updates flow from [com.red.sovereign.service.webrtc.TelecomCallController] directly
 * to [com.red.sovereign.service.webrtc.REDCallManager.onAudioDeviceChanged], bypassing this class entirely.
 */
@RequiresApi(34)
class TelecomAudioManager(context: Context, eventListener: EventListener?) : REDAudioManager(context, eventListener) {
