...
package com.red.sovereign.window
...
import com.red.sovereign.main.MainFloatingActionButtonsCallback
import com.red.sovereign.main.MainNavigationBar
import com.red.sovereign.main.MainNavigationRail
import com.red.sovereign.main.MainNavigationState
...
fun AppScaffold(
  ...
  val isForceSinglePane = if (LocalInspectionMode.current) {
    ...
    REDStore.internal.forceSinglePane
  }
