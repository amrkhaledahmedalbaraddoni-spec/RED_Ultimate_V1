 ...
 *
 * Bypasses [com.red.sovereign.backup.v2.local.LocalArchiver] and
 * [com.red.sovereign.backup.v2.local.SnapshotFileSystem] to avoid
  ...
  private fun startRestore() {
    lifecycleScope.launch(Dispatchers.IO) {
      try {
        ...
        val signalBackupsDir = File(backupDir, "REDBackups")
