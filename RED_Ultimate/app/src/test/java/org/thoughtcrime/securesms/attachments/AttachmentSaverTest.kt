...
import com.red.sovereign.attachments.AttachmentSaver.Host
import com.red.sovereign.attachments.AttachmentSaver.RequestPermissionResult
import com.red.sovereign.attachments.AttachmentSaver.SaveToStorageWarningResult
import com.red.sovereign.keyvalue.REDStore
import com.red.sovereign.keyvalue.UiHintValues
import com.red.sovereign.testing.CoroutineDispatcherRule
...
class AttachmentSaverTest {
  ...
  private val testAttachments: Set<SaveAttachmentUtil.SaveAttachment> = setOf(
    SaveAttachmentUtil.SaveAttachment(
      uri = Uri.parse("content://com.red.sovereign/part/111"),
    ...
    SaveAttachmentUtil.SaveAttachment(
      uri = Uri.parse("content://com.red.sovereign/part/222"),
      contentType = "image/jpeg",
      date = 1742234384758,
      fileName = null
    )
