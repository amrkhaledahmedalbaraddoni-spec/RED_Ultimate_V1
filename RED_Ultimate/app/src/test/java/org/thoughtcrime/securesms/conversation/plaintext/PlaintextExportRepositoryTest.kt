...
import com.red.sovereign.conversation.plaintext.PlaintextExportRepository.PendingAttachment
import com.red.sovereign.database.FakeMessageRecords
...
class PlaintextExportRepositoryTest {
  ...
  fun setUp() {
    ...
    val mockLiveRecipient = mockk<com.red.sovereign.recipients.LiveRecipient>(relaxed = true)
  ...
  private fun renderMessage(
    message: com.red.sovereign.database.model.MmsMessageRecord,
    attachments: List<com.red.sovereign.attachments.DatabaseAttachment> = emptyList(),
