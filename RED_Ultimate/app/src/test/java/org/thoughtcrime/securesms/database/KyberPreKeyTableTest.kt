...
class KyberPreKeyTableTest {
  ...
  fun markAllStaleIfNecessary_onlyUpdatesMatchingAccountAndZeroValues() {
    ...
    REDDatabase.kyberPreKeys.markAllStaleIfNecessary(aci, now)
  ...
  fun deleteAllStaleBefore_deleteOldBeforeThreshold() {
    ...
    REDDatabase.kyberPreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 0)
  ...
  fun deleteAllStaleBefore_neverDeleteStaleOfZero() {
    ...
    REDDatabase.kyberPreKeys.deleteAllStaleBefore(aci, threshold = 10, minCount = 1)
  ...
  fun deleteAllStaleBefore_respectMinCount() {
    ...
    REDDatabase.kyberPreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 3)
  ...
  fun deleteAllStaleBefore_respectAccount() {
    ...
    REDDatabase.kyberPreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 2)
  ...
  fun handleMarkKyberPreKeyUsed_doesNotAllowDuplicateLastResortKeyEntries() {
    ...
    REDDatabase.kyberPreKeys.handleMarkKyberPreKeyUsed(
      serviceId = aci,
      kyberPreKeyId = 1,
      signedPreKeyId = 1,
      baseKey = publicKey
  ...
  private fun insertTestRecord(account: ServiceId, id: Int, staleTime: Long = 0, lastResort: Boolean = false) {
    ...
    REDDatabase.kyberPreKeys.insert(
      serviceId = account,
      keyId = id,
    ...
    val count = REDDatabase.writableDatabase
