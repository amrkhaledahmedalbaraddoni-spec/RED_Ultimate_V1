...
class OneTimePreKeyTableTest {
  ...
  fun markAllStaleIfNecessary_onlyUpdatesMatchingAccountAndZeroValues() {
    ...
    REDDatabase.oneTimePreKeys.markAllStaleIfNecessary(aci, now)
  ...
  fun deleteAllStaleBefore_deleteOldBeforeThreshold() {
    ...
    REDDatabase.oneTimePreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 0)
  ...
  fun deleteAllStaleBefore_neverDeleteStaleOfZero() {
    ...
    REDDatabase.oneTimePreKeys.deleteAllStaleBefore(aci, threshold = 10, minCount = 0)
  ...
  fun deleteAllStaleBefore_respectMinCount() {
    ...
    REDDatabase.oneTimePreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 3)
  ...
  fun deleteAllStaleBefore_respectAccount() {
    ...
    REDDatabase.oneTimePreKeys.deleteAllStaleBefore(aci, threshold = 11, minCount = 2)
  ...
  private fun insertTestRecord(account: ServiceId, id: Int, staleTime: Long = 0) {
    REDDatabase.oneTimePreKeys.insert(
      serviceId = account,
      keyId = id,
