...
import org.signal.libsignal.protocol.logging.REDProtocolLogger
...
import com.red.sovereign.TestZkGroupServer
import com.red.sovereign.database.GroupStateTestData
import com.red.sovereign.database.GroupTable
import com.red.sovereign.database.RecipientDatabaseTestUtils
...
class GroupManagerV2Test_edit {
  ...
  fun setUp() {
    ...
    REDProtocolLoggerProvider.initializeLogging(REDProtocolLogger.INFO)
