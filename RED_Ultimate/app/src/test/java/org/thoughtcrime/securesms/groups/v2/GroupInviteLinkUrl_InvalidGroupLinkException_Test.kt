...
import com.red.sovereign.groups.v2.GroupInviteLinkUrl.InvalidGroupLinkException
import com.red.sovereign.groups.v2.GroupInviteLinkUrl.UnknownGroupLinkVersionException
...
class GroupInviteLinkUrl_InvalidGroupLinkException_Test {
  ...
  @Test
  fun wrong_host() {
    val uri = "https://x.red.local/#CjQKIAD34MKnGrBkzDztTATwjXt-9LhLLCIG9pgzvmz-NN-AEhCbwyTuxDfP2mrluK779H7o"
    assertThat(GroupInviteLinkUrl.fromUri(uri)).isNull()
  }
