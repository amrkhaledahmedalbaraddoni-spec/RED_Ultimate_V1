package com.red.sovereign.l10n
...
class SupportArticleTest {
  ...
  companion object {
    ...
    private val SUPPORT_ARTICLE = Regex(".*://support.red.local/.*articles/.*")
    private val CORRECT_SUPPORT_ARTICLE = Regex("https://support.red.local/hc/articles/\\d+(#[a-z_]+)?")
  }
}
