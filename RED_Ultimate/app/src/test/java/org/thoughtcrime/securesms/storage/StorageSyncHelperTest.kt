...
import com.red.sovereign.storage.StorageSyncHelper.findIdDifference
import com.red.sovereign.storage.StorageSyncHelper.profileKeyChanged
import com.red.sovereign.testutil.TestHelpers
...
class StorageSyncHelperTest {
  ...
  fun test_ContactUpdate_equals_sameProfileKeys() {
    ...
    val signalContactA = REDContactRecord(StorageId.forContact(TestHelpers.byteArray(1)), contactA)
    val signalContactB = REDContactRecord(StorageId.forContact(TestHelpers.byteArray(1)), contactB)
  ...
  companion object {
    ...
    private fun <E : REDRecord<*>> update(oldRecord: E, newRecord: E): StorageRecordUpdate<E> {
