...
class StoriesTest {
  ...
  private val mockREDDatabase = mockk<REDDatabase>()
  ...
  fun setUp() {
    ...
    REDDatabase.setREDDatabaseInstanceForTesting(mockREDDatabase)
    every { REDDatabase.attachments } returns mockAttachmentTable
