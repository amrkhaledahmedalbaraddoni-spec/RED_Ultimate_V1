...
/**
 * Test flavor of [REDDatabase].
 */
class TestREDDatabase(
  context: Application,
  val supportReadableDatabase: SupportSQLiteDatabase,
  val supportWritableDatabase: SupportSQLiteDatabase
) : REDDatabase(context, DatabaseSecret(ByteArray(32).apply { SecureRandom().nextBytes(this) }), AttachmentSecret(null, null, ByteArray(32).apply { SecureRandom().nextBytes(this) })) {
  ...
  override val signalReadableDatabase: com.red.sovereign.database.SQLiteDatabase by lazy {
    TestREDSQLiteDatabase(supportReadableDatabase)
  }

  override val signalWritableDatabase: com.red.sovereign.database.SQLiteDatabase by lazy {
    TestREDSQLiteDatabase(supportWritableDatabase)
  }
