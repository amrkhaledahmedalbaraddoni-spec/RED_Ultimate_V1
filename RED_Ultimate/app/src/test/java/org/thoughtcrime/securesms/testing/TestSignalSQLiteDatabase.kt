...
/**
 * Partial implementation of [REDSQLiteDatabase] using an instance of [AndroidSQLiteDatabase] instead
 * of SQLCipher.
 */
class TestREDSQLiteDatabase(private val database: SupportSQLiteDatabase) : REDSQLiteDatabase(null) {
