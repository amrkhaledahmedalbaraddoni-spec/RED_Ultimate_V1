...
import com.red.sovereign.testing.TestREDSQLiteDatabase

class REDDatabaseMigrationRule(private val upgradedVersion: Int = 286) : ExternalResource() {
  ...
  companion object {
    ...
    private fun inMemoryUpgradedDatabase(): SQLiteDatabase {
      ...
      return TestREDSQLiteDatabase(db)
    }
