...
import com.red.sovereign.util.REDMeUtil.parseE164FromLink

@RunWith(Parameterized::class)
class REDMeUtilText_parseE164FromLink(private val input: String?, private val output: String?) {

  @Before
  fun setUp() {
    mockkObject(REDStore)
    every { REDStore.account.e164 } returns "+15555555555"
  }
