...
public class REDProxyUtilText_convertUserEnteredAddressToHost {
  ...
  public REDProxyUtilText_convertUserEnteredAddressToHost(String input, String output) {
    this.input  = input;
    this.output = output;
  }
  ...
  @Test
  public void parse() {
    assertEquals(output, REDProxyUtil.convertUserEnteredAddressToHost(input));
  }
}
