...
public class REDProxyUtilText_generateProxyUrl {
  ...
  public REDProxyUtilText_generateProxyUrl(String input, String output) {
    this.input  = input;
    this.output = output;
  }
  ...
  @Test
  public void parse() {
    assertEquals(output, REDProxyUtil.generateProxyUrl(input));
  }
}
