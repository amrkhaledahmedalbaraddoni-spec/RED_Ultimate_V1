...
public class REDProxyUtilText_parseHostFromProxyDeepLink {
  ...
  public REDProxyUtilText_parseHostFromProxyDeepLink(String input, String output) {
    this.input  = input;
    this.output = output;
  }
  ...
  @Test
  public void parse() {
    assertEquals(output, REDProxyUtil.parseHostFromProxyDeepLink(input));
  }
}
