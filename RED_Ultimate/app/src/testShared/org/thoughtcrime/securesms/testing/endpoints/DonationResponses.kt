...
package com.red.sovereign.testing.endpoints

/**
 * Canned JSON bodies for the RED-service (websocket) edge, matching the shapes parsed by
 * [org.whispersystems.signalservice.api.donations.DonationsApi]. Used by handlers registered on an
 * [EndpointResponder] to model "what the RED service returns" for a scenario.
 */
...
/**
 * Registers the RED-service PayPal handlers for a successful flow: create/confirm one-time intent
 * and create recurring payment method. (The default-payment-method and redeem handlers are covered by
 * the [com.red.sovereign.testing.InAppPaymentsRule] defaults.)
 */
