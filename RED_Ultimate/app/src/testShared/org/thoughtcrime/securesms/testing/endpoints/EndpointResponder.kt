 ...
 * outer network edges the donation pipeline talks to: Stripe over HTTP and the RED service over
 * the websocket.
 */
 ...
 * websocket transport (RED service). Handlers registered on an [EndpointResponder] are matched
