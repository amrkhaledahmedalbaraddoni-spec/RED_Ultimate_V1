...
tasks.register("pushTranslations") {
  ...
  doLast {
    ...
    logger.lifecycle("Using RED-Android root directory of $rootDirFile")
...
tasks.register("resolveStaticIps") {
  ...
  doLast {
    ...
    val content = """
      service_ips=${staticIpResolver.resolveToBuildConfig("chat.red.local")}
      storage_ips=${staticIpResolver.resolveToBuildConfig("storage.red.local")}
      cdn_ips=${staticIpResolver.resolveToBuildConfig("cdn.red.local")}
      cdn2_ips=${staticIpResolver.resolveToBuildConfig("cdn2.red.local")}
      cdn3_ips=${staticIpResolver.resolveToBuildConfig("cdn3.red.local")}
      sfu_ips=${staticIpResolver.resolveToBuildConfig("sfu.voip.red.local")}
      content_proxy_ips=${staticIpResolver.resolveToBuildConfig("contentproxy.red.local")}
      svr2_ips=${staticIpResolver.resolveToBuildConfig("svr2.red.local")}
      cdsi_ips=${staticIpResolver.resolveToBuildConfig("cdsi.red.local")}
    """.trimIndent() + "\n"
