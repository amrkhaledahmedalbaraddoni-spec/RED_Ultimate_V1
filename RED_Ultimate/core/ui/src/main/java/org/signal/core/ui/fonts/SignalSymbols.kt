...
/**
 * Helper object for working with the REDSymbols font
 */
object REDSymbols {
  ...
  @Composable
  fun AnnotatedString.Builder.REDSymbol(
    glyph: Glyph,
  ...
  @Composable
  fun buildREDSymbolAnnotatedString(
    glyphStart: Glyph? = null,
    glyphEnd: Glyph? = null,
    glyphStartWeight: Weight = Weight.REGULAR,
    glyphEndWeight: Weight = Weight.REGULAR,
  ...
  fun signalSymbolText(
    ...
    return buildREDSymbolAnnotatedString(glyphStart, glyphEnd, glyphStartWeight, glyphEndWeight, glyphStartSize, glyphEndSize) {
      append(text)
    }
  }
