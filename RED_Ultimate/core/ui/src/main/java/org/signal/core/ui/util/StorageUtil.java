...
public class StorageUtil {
  ...
  private static final String PRODUCTION_PACKAGE_ID = "com.red.sovereign";
  ...
  public static File getBackupDirectory() throws NoExternalStorageException {
    File   storage   = Environment.getExternalStorageDirectory();
    File   signal    = new File(storage, "RED");
  ...
  public static File getBackupV2Directory() throws NoExternalStorageException {
    File   storage   = Environment.getExternalStorageDirectory();
    File   backups   = new File(storage, "RED");
    String packageId = CoreUiDependencies.INSTANCE.getPackageId();
  ...
  private static File getREDStorageDir() throws NoExternalStorageException {
  ...
  public static boolean canWriteInREDStorageDir() {
    File storage;

    try {
      storage = getREDStorageDir();
