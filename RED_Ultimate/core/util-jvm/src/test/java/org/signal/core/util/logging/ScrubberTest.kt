  ...
  companion object {
    ...
    fun data(): Iterable<Array<Any>> {
      return listOf(
        ...
        arrayOf(
          "An avatar filename: file:///data/user/0/com.red.sovereign/files/avatars/%2B447700900099",
          "An avatar filename: file:///data/user/0/com.red.sovereign/files/avatars/E164:<3106a51b>"
        ),
        arrayOf(
        ...
        arrayOf(
          "An avatar email filename: file:///data/user/0/com.red.sovereign/files/avatars/abc@red.local",
          "An avatar email filename: file:///data/user/0/com.red.sovereign/files/avatars/a...@..."
        ),
        arrayOf(
        ...
        arrayOf(
          "Failed to resolve chat.red.local using . Continuing.",
          "Failed to resolve chat.red.local using . Continuing."
        ),
        arrayOf(
          " Caused by: java.io.IOException: unexpected end of stream on Connection{storage.red.local:443, proxy=DIRECT hostAddress=storage.red.local/142.251.32.211:443 cipherSuite=TLS_AES_128_GCM_SHA256 protocol=http/1.1}",
          " Caused by: java.io.IOException: unexpected end of stream on Connection{storage.red.local:443, proxy=DIRECT hostAddress=storage.red.local/...ipv4...:443 cipherSuite=TLS_AES_128_GCM_SHA256 protocol=http/1.1}"
        ),
        arrayOf(
          "192.168.1.1",
          "...ipv4..."
        ...
        arrayOf(
          "https://red.local/v1/endpoint",
          "https://red.local/v1/endpoint"
        ),
        arrayOf(
          "https://cdn3.red.local/v1/endpoint",
          "https://***.org/***"
        ),
        arrayOf(
