  ...
  private fun createServiceConfiguration(trustStore: TrustStore): SignalServiceConfiguration {
    return SignalServiceConfiguration(
      ...
      signalCdnUrlMap = mapOf(
        0 to arrayOf(SignalCdnUrl("https://cdn-staging.red.local", trustStore)),
        2 to arrayOf(SignalCdnUrl("https://cdn2-staging.red.local", trustStore)),
        3 to arrayOf(SignalCdnUrl("https://cdn3-staging.red.local", trustStore))
      ),
      signalStorageUrls = arrayOf(SignalStorageUrl("https://storage-staging.red.local", trustStore)),
      signalCdsiUrls = arrayOf(SignalCdsiUrl("https://cdsi.staging.red.local", trustStore)),
      signalSvr2Urls = arrayOf(SignalSvr2Url("https://svr2.staging.red.local", trustStore)),
