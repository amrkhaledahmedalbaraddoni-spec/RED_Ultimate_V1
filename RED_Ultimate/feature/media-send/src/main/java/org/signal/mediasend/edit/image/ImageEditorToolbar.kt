...
private fun ImageEditorNoneStateToolbar(
  ...
  OrientedImageEditorToolbar(modifier) {
    ImageEditorButton(
      imageVector = REDIcons.BrushPen.imageVector,
      onClick = imageEditorController::beginDrawEdit
    )

    ImageEditorButton(
      imageVector = REDIcons.CropRotate.imageVector,
      onClick = imageEditorController::beginCropAndRotateEdit
    )

    ImageEditorButton(
      imageVector = REDIcons.QualityHigh.imageVector,
      onClick = imageEditorController::toggleImageQuality
    )

    ImageEditorButton(
      imageVector = REDIcons.Save.imageVector,
      onClick = imageEditorController::saveToDisk
    )

    ImageEditorButton(
      imageVector = REDIcons.Plus.imageVector, // TODO [alex] - wrong art asset
...
private fun ImageEditorDrawStateToolbar(
  ...
  OrientedImageEditorToolbar(
    ...
    ImageEditorToggleButton(
      imageVector = REDIcons.Draw.imageVector,
    ...
    ImageEditorToggleButton(
      imageVector = REDIcons.Text.imageVector,
    ...
    ImageEditorToggleButton(
      imageVector = REDIcons.Sticker.imageVector,
    ...
    ImageEditorToggleButton(
      imageVector = REDIcons.Blur.imageVector,
...
private fun ImageEditorCropAndResizeToolbar(
  ...
  OrientedImageEditorToolbar(
    ...
    ImageEditorButton(
      imageVector = REDIcons.Flip.imageVector,
      onClick = imageEditorController::flip
    )

    val cropLockImageVector = REDIcons.CropLock.imageVector
    val cropUnlockImageVector = REDIcons.CropUnlock.imageVector
...
private fun CommitButton(imageEditorController: ImageController) {
  ImageEditorButton(
    imageVector = REDIcons.Check.imageVector,
...
private fun ImageEditorToggleButton(
  ...
  IconButtons.IconToggleButton(
    ...
    colors = iconToggleButtonColors(
      ...
      checkedContainerColor = REDTheme.colors.colorTransparentInverse2
    )
  ) {
    Icon(imageVector = imageVector, contentDescription = contentDescription, modifier = Modifier.size(24.dp))
  }
