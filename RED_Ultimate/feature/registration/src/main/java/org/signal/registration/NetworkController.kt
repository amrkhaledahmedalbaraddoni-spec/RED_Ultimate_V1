...
interface NetworkController {
  ...
  /**
   * Request an SMS verification code. On success, the server will send an SMS verification code to this RED user.
   *
   ...
   * module (it references REDDatabase / FullBackupImporter / REDStore), as does the
   ...
   *   pulls the AEP from `REDStore.account` directly); demo/test implementations need it
   ...
   * them on RED by their phone number.
   *
   ...
   *   on RED; if false, the user is only reachable via existing chats.
   */
