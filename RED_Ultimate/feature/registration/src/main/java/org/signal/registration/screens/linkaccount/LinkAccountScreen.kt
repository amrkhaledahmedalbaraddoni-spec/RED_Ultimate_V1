  ...
  Box(
    ...
    AnimatedVisibility(
      ...
      IconButtons.IconButton(
        ...
        Icon(
          imageVector = REDIcons.Maximize.imageVector,
...
private fun QrCodeScanned() {
  Column(
    ...
    Icon(
      imageVector = REDIcons.CheckCircle.imageVector,
...
@Composable
private fun DontHaveRED(onEvent: (LinkAccountScreenEvent) -> Unit) {
  Text(
    text = buildAnnotatedString {
      REDSymbol(glyph = REDSymbols.Glyph.DEVICE_PHONE)
      append(' ')
