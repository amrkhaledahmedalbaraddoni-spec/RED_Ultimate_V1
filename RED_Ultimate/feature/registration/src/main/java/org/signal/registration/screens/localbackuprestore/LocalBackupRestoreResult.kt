...
sealed interface LocalBackupRestoreResult {
  ...
  /**
   * The backup belongs to a different account and the user chose to restore it anyway. The phone number must be
   * verified over SMS, after which the restore recorded in [RegistrationFlowState.pendingLocalBackupRestore] runs.
   */
  data object DeferredToSms : LocalBackupRestoreResult
