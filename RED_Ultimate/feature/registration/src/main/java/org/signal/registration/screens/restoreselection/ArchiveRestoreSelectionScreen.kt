...
private fun RestoreOptionCard(
  ...
  when (option) {
    ArchiveRestoreOption.REDSecureBackup -> {
      SelectionCard(
        imageVector = REDIcons.REDBackupsDisplay.imageVector,
    ...
    ArchiveRestoreOption.DeviceTransfer -> {
      SelectionCard(
        imageVector = REDIcons.TransferDisplay.imageVector,
    ...
    ArchiveRestoreOption.LocalBackup -> {
      SelectionCard(
        imageVector = REDIcons.FolderDisplay.imageVector,
    ...
    ArchiveRestoreOption.None -> {
      SelectionCard(
        imageVector = REDIcons.MobileNextDisplay.imageVector,
...
private fun ArchiveRestoreSelectionScreenPreview() {
  Previews.Preview {
    ArchiveRestoreSelectionScreen(
      state = ArchiveRestoreSelectionState(
        restoreOptions = listOf(ArchiveRestoreOption.REDSecureBackup, ArchiveRestoreOption.LocalBackup, ArchiveRestoreOption.DeviceTransfer, ArchiveRestoreOption.None)
      ),
      onEvent = {}
    )
  }
