...
class ArchiveRestoreSelectionScreenTest {
  ...
  @Test
  fun `when RED Backups card is clicked, RestoreOptionSelected REDSecureBackup is emitted`() {
    ...
    assert(emittedEvent == ArchiveRestoreSelectionScreenEvents.RestoreOptionSelected(ArchiveRestoreOption.REDSecureBackup))
  }
