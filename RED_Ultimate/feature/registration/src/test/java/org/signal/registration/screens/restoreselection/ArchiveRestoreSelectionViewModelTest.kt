...
class ArchiveRestoreSelectionViewModelTest {
  ...
  private fun createViewModel(
    restoreOptions: List<ArchiveRestoreOption> = listOf(
      ArchiveRestoreOption.REDSecureBackup,
  ...
  @Test
  fun `REDSecureBackup pre-registration emits PendingRestoreOptionSelected and navigates to PhoneNumberEntry`() = runTest {
    ...
    viewModel.applyEvent(
      initialState,
      ArchiveRestoreSelectionScreenEvents.RestoreOptionSelected(ArchiveRestoreOption.REDSecureBackup),
      stateEmitter
    )
  ...
  @Test
  fun `REDSecureBackup post-registration navigates to EnterAepForRemoteBackupPostRegistration`() = runTest {
  ...
  fun `initial state contains provided restore options`() = runTest {
    val options = listOf(ArchiveRestoreOption.REDSecureBackup, ArchiveRestoreOption.None)
