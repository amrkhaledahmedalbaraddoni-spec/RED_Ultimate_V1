...
class EncryptedBackupReader private constructor(
  ...
  companion object {
    ...
    fun createForREDBackup(
      ...
      return createForREDBackup(key, key.deriveBackupId(aci), forwardSecrecyToken, length, dataStream)
    }
    ...
    /**
     * Create a reader for a local backup or for a transfer to a linked device. Basically everything that isn't [createForREDBackup].
