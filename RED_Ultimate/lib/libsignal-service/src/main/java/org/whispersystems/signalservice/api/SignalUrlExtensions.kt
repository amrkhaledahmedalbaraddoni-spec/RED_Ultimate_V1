 ...
 */
fun <T : REDUrl> Array<T>.chooseUrl(): T {
  return this[(Math.random() * size).toInt()]
}

/**
 * Build and configure an [OkHttpClient] as defined by the target [REDUrl] and provided [configuration].
 */
fun <T : REDUrl> T.buildOkHttpClient(configuration: REDServiceConfiguration): OkHttpClient {
