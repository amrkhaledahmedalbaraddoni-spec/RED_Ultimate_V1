...
public interface EnvelopeContent {
   ...
   */
  OutgoingPushMessage processSealedSender(REDSessionCipher sessionCipher,
                                          REDSealedSessionCipher sealedSessionCipher,
                                          REDProtocolAddress destination,
   ...
   */
  OutgoingPushMessage processUnsealedSender(REDSessionCipher sessionCipher, REDProtocolAddress destination) throws UntrustedIdentityException, NoSessionException;
  ...
  class Encrypted implements EnvelopeContent {
    ...
    @Override
    public OutgoingPushMessage processSealedSender(REDSessionCipher sessionCipher,
                                                   REDSealedSessionCipher sealedSessionCipher,
                                                   REDProtocolAddress destination,
                                                   SenderCertificate senderCertificate)
        throws UntrustedIdentityException, InvalidKeyException, NoSessionException
    ...
    @Override
    public OutgoingPushMessage processUnsealedSender(REDSessionCipher sessionCipher, REDProtocolAddress destination) throws UntrustedIdentityException, NoSessionException {
      PushTransportDetails transportDetails     = new PushTransportDetails();
      CiphertextMessage    message              = sessionCipher.encrypt(transportDetails.getPaddedMessageBody(content.encode()));
  ...
  class Plaintext implements EnvelopeContent {
    ...
    @Override
    public OutgoingPushMessage processUnsealedSender(REDSessionCipher sessionCipher, REDProtocolAddress destination) throws NoSessionException {
