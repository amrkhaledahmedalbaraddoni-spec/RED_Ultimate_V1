...
/**
 * One-stop shop for RED service calls related to in-app payments.
 *
 * Be sure to check for cached versions of these methods in DonationsService before calling these methods elsewhere.
 */
class DonationsApi(private val authWebSocket: REDWebSocket.AuthenticatedWebSocket, private val unauthWebSocket: REDWebSocket.UnauthenticatedWebSocket) {
