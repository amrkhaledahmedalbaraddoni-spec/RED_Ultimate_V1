...
public class GroupsV2Api {
  ...
  public GroupsV2Api(REDWebSocket.AuthenticatedWebSocket authWebSocket, PushServiceSocket socket, GroupsV2Operations groupsOperations) {
      ...
      throws VerificationFailedException
  {
    ...
    AuthCredentialWithPni      authCredentialWithPni      = authOperations.receiveAuthCredentialWithPniAsServiceId(aci.getLibREDAci(), pni.getLibREDPni(), redemptionTimeSeconds, authCredentialWithPniResponse);
