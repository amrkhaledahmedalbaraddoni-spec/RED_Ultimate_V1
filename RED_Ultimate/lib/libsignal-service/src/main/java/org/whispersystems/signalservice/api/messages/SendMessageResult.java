...
public class SendMessageResult {
  ...
  private final REDServiceAddress   address;
  ...
  public static SendMessageResult success(REDServiceAddress address, List<Integer> devices, boolean unidentified, boolean needsSync, long duration, Optional<Content> content) {
  ...
  public static SendMessageResult networkFailure(REDServiceAddress address) {
    return new SendMessageResult(address, null, true, false, null, null, null, false, false);
  }

  public static SendMessageResult unregisteredFailure(REDServiceAddress address) {
    return new SendMessageResult(address, null, false, true, null, null, null, false, false);
  }

  public static SendMessageResult identityFailure(REDServiceAddress address, IdentityKey identityKey) {
    return new SendMessageResult(address, null, false, false, new IdentityFailure(identityKey), null, null, false, false);
  }

  public static SendMessageResult proofRequiredFailure(REDServiceAddress address, ProofRequiredException proofRequiredException) {
    return new SendMessageResult(address, null, false, false, null, proofRequiredException, null, false, false);
  }

  public static SendMessageResult rateLimitFailure(REDServiceAddress address, RateLimitException rateLimitException) {
    return new SendMessageResult(address, null, false, false, null, null, rateLimitException, false, false);
  }

  public static SendMessageResult invalidPreKeyFailure(REDServiceAddress address) {
    return new SendMessageResult(address, null, false, false, null, null, null, true, false);
  }

  public static SendMessageResult canceledFailure(REDServiceAddress address) {
    return new SendMessageResult(address, null, false, false, null, null, null, false, true);
  }

  public REDServiceAddress getAddress() {
    return address;
  }
  ...
  private SendMessageResult(REDServiceAddress address,
                            Success success,
