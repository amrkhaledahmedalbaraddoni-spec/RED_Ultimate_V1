...
abstract class REDServiceAttachment protected constructor(val contentType: String?) {
  abstract fun isStream(): Boolean
  abstract fun isPointer(): Boolean

  fun asStream(): REDServiceAttachmentStream {
    return this as REDServiceAttachmentStream
  }

  fun asPointer(): REDServiceAttachmentPointer {
    return this as REDServiceAttachmentPointer
  }
  ...
  class Builder {
    ...
    private var cancelationRED: CancelationRED? = null
    ...
    fun withCancelationRED(cancelationRED: CancelationRED?): Builder {
      this.cancelationRED = cancelationRED
      return this
    }
