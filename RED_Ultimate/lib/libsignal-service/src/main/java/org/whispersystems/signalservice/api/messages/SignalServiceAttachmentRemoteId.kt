 ...
 */
sealed interface REDServiceAttachmentRemoteId {

  object S3 : REDServiceAttachmentRemoteId {
    override fun toString() = ""
  }

  data class V2(val cdnId: Long) : REDServiceAttachmentRemoteId {
    override fun toString() = cdnId.toString()
  }

  data class V4(val cdnKey: String) : REDServiceAttachmentRemoteId {
    override fun toString() = cdnKey
  }

  data class Backup(val mediaCdnPath: String, val mediaId: String) : REDServiceAttachmentRemoteId {
  ...
  companion object {
    ...
    fun from(attachmentPointer: AttachmentPointer): REDServiceAttachmentRemoteId {
    ...
    @JvmStatic
    fun from(string: String, cdnNumber: Int): REDServiceAttachmentRemoteId {
