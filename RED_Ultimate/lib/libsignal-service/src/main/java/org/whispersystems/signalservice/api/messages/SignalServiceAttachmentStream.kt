...
/**
 * Represents a local REDServiceAttachment to be sent.
 */
class REDServiceAttachmentStream(
  ...
  val cancelationRED: CancelationRED?,
  val resumableUploadSpec: Optional<ResumableUploadSpec>,
  val uuid: UUID?
) : REDServiceAttachment(contentType!!), Closeable {
  constructor(
