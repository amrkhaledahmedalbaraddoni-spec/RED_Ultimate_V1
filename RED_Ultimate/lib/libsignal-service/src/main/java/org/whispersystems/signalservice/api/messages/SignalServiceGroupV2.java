...
/**
 * Group information to include in REDServiceMessages destined to v2 groups.
 * <p>
 * This class represents a "context" that is included with RED Service messages
 * to make them group messages.
 */
public final class REDServiceGroupV2 {

  private final GroupMasterKey masterKey;
  private final int            revision;
  private final byte[]         signedGroupChange;

  private REDServiceGroupV2(Builder builder) {
   ...
   */
  public static REDServiceGroupV2 fromProtobuf(@NonNull GroupContextV2 groupContextV2) {
  ...
  public static class Builder {
    ...
    public REDServiceGroupV2 build() {
      return new REDServiceGroupV2(this);
    }
  }
}
