...
public final class REDServiceMetadata {
  private final REDServiceAddress sender;
  ...
  public REDServiceMetadata(REDServiceAddress sender,
                               int senderDevice,
                               long timestamp,
  ...
  public REDServiceAddress getSender() {
    return sender;
  }
