...
public class REDServiceTextAttachment {
  ...
  public static REDServiceTextAttachment forGradientBackground(Optional<String>               text,
                                                                  Optional<Style>                style,
                                                                  Optional<Integer>              textForegroundColor,
                                                                  Optional<Integer>              textBackgroundColor,
                                                                  Optional<REDServicePreview> preview,
                                                                  Gradient                       backgroundGradient) {
    return new REDServiceTextAttachment(text,
                                           style,
                                           textForegroundColor,
                                           textBackgroundColor,
                                           preview,
  ...
  public static REDServiceTextAttachment forSolidBackground(Optional<String>               text,
                                                               Optional<Style>                style,
                                                               Optional<Integer>              textForegroundColor,
                                                               Optional<Integer>              textBackgroundColor,
                                                               Optional<REDServicePreview> preview,
  ...
  public Optional<REDServicePreview> getPreview() {
    return preview;
  }
