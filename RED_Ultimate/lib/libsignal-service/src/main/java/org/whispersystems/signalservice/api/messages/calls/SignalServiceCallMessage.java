...
public class REDServiceCallMessage {
  ...
  private REDServiceCallMessage(Optional<OfferMessage> offerMessage,
  ...
  public static REDServiceCallMessage forOffer(OfferMessage offerMessage, Integer destinationDeviceId) {
    return new REDServiceCallMessage(Optional.of(offerMessage),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceCallMessage forAnswer(AnswerMessage answerMessage, Integer destinationDeviceId) {
    return new REDServiceCallMessage(Optional.empty(),
  ...
  public static REDServiceCallMessage forIceUpdates(List<IceUpdateMessage> iceUpdateMessages, Integer destinationDeviceId) {
    return new REDServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceCallMessage forIceUpdate(final IceUpdateMessage iceUpdateMessage, Integer destinationDeviceId) {
  ...
  public static REDServiceCallMessage forHangup(HangupMessage hangupMessage, Integer destinationDeviceId) {
    return new REDServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceCallMessage forBusy(BusyMessage busyMessage, Integer destinationDeviceId) {
    return new REDServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceCallMessage forOpaque(OpaqueMessage opaqueMessage, Integer destinationDeviceId) {
    return new REDServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceCallMessage forOutgoingGroupOpaque(byte[] groupId, long timestamp, OpaqueMessage opaqueMessage, Integer destinationDeviceId) {
    return new REDServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceCallMessage empty() {
    return new REDServiceCallMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
