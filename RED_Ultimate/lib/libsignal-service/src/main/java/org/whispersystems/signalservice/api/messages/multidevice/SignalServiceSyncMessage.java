...
public class REDServiceSyncMessage {
  ...
  private REDServiceSyncMessage(Optional<SentTranscriptMessage> sent,
  ...
  public static REDServiceSyncMessage forSentTranscript(SentTranscriptMessage sent) {
    return new REDServiceSyncMessage(Optional.of(sent),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forContacts(ContactsMessage contacts) {
    return new REDServiceSyncMessage(Optional.empty(),
  ...
  public static REDServiceSyncMessage forRequest(RequestMessage request) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.of(request),
  ...
  public static REDServiceSyncMessage forRead(List<ReadMessage> reads) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forViewed(List<ViewedMessage> views) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forViewOnceOpen(ViewOnceOpenMessage timerRead) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forRead(ReadMessage read) {
  ...
  public static REDServiceSyncMessage forVerified(VerifiedMessage verifiedMessage) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forBlocked(BlockedListMessage blocked) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.of(blocked),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forConfiguration(ConfigurationMessage configuration) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forStickerPackOperations(List<StickerPackOperationMessage> stickerPackOperations) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forFetchLatest(FetchType fetchType) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forKeys(KeysMessage keys) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forMessageRequestResponse(MessageRequestResponseMessage messageRequestResponse) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forOutgoingPayment(OutgoingPaymentMessage outgoingPaymentMessage) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forCallEvent(@Nonnull CallEvent callEvent) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forCallLinkUpdate(@Nonnull CallLinkUpdate callLinkUpdate) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forCallLogEvent(@Nonnull CallLogEvent callLogEvent) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forDeviceNameChange(@Nonnull DeviceNameChange deviceNameChange) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forAttachmentBackfillResponse(@Nonnull AttachmentBackfillResponse backfillResponse) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage forAttachmentBackfillRequest(@Nonnull AttachmentBackfillRequest backfillRequest) {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
  ...
  public static REDServiceSyncMessage empty() {
    return new REDServiceSyncMessage(Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
                                        Optional.empty(),
