...
public class SharedContact {
  ...
  public static class Avatar {
    private final REDServiceAttachment attachment;
    private final boolean                 isProfile;

    public Avatar(REDServiceAttachment attachment, boolean isProfile) {
      this.attachment = attachment;
      this.isProfile  = isProfile;
    }

    public REDServiceAttachment getAttachment() {
      return attachment;
    }
    ...
    public static class Builder {
      private REDServiceAttachment attachment;
      private boolean                 isProfile;

      public Builder withAttachment(REDServiceAttachment attachment) {
        this.attachment = attachment;
        return this;
      }
