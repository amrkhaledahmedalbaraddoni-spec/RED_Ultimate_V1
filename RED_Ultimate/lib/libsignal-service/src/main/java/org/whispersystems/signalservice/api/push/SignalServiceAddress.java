 ...
 */
public class REDServiceAddress {
   ...
   */
  public REDServiceAddress(ServiceId serviceId, Optional<String> e164) {
    this.serviceId = Preconditions.checkNotNull(serviceId);
    this.e164      = e164;
  }

  @SuppressWarnings("NewApi")
  public REDServiceAddress(ServiceId serviceId) {
    this.serviceId = Preconditions.checkNotNull(serviceId);
   ...
   */
  public REDServiceAddress(ServiceId serviceId, String e164) {
  ...
  public boolean matches(REDServiceAddress other) {
  ...
  public static Optional<REDServiceAddress> fromRaw(String rawUuid, String e164) {
    if (isValidAddress(rawUuid, e164)) {
      return Optional.of(new REDServiceAddress(ServiceId.parseOrThrow(rawUuid), e164));
    } else {
  ...
  @Override public boolean equals(Object o) {
    ...
    final REDServiceAddress that = (REDServiceAddress) o;
