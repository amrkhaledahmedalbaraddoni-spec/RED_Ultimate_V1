...
data class REDStorageManifest(
  ...
  companion object {
    val EMPTY: REDStorageManifest = REDStorageManifest(0, 1, null, emptyList())

    fun deserialize(serialized: ByteArray): REDStorageManifest {
