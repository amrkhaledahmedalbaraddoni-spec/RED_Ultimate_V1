...
public final class AttachmentPointerUtil {
  public static REDServiceAttachmentPointer createREDAttachmentPointer(byte[] pointer) throws InvalidMessageStructureException, IOException {
    return createREDAttachmentPointer(AttachmentPointer.ADAPTER.decode(pointer));
  }

  public static REDServiceAttachmentPointer createREDAttachmentPointer(AttachmentPointer pointer) throws InvalidMessageStructureException {
    ...
    return new REDServiceAttachmentPointer(pointer.cdnNumber,
                                              REDServiceAttachmentRemoteId.from(pointer),
                                              pointer.contentType,
  ...
  public static AttachmentPointer createAttachmentPointer(REDServiceAttachmentPointer attachment) {
    ...
    if (attachment.getRemoteId() instanceof REDServiceAttachmentRemoteId.V2) {
      builder.cdnId(((REDServiceAttachmentRemoteId.V2) attachment.getRemoteId()).getCdnId());
    }

    if (attachment.getRemoteId() instanceof REDServiceAttachmentRemoteId.V4) {
      builder.cdnKey(((REDServiceAttachmentRemoteId.V4) attachment.getRemoteId()).getCdnKey());
    }
