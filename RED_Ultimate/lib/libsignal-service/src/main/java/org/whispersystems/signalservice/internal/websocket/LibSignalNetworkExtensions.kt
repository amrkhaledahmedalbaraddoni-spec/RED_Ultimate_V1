 ...
 */
@file:JvmName("LibREDNetworkExtensions")
...
private const val TAG = "LibREDNetworkExtensions"

/**
 * Helper method to apply settings from the REDServiceConfiguration.
 */
fun Network.applyConfiguration(config: REDServiceConfiguration) {
