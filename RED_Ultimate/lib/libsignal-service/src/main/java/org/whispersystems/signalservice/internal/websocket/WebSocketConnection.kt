 ...
 *  - LibREDChatConnection - the wrapper around libsignal's [org.signal.libsignal.net.ChatService]
 */
interface WebSocketConnection {
   ...
   * This is specifically for LibRED-based connections to access the native connection.
   *
  ...
  suspend fun <T> runWithChatConnection(callback: (org.signal.libsignal.net.ChatConnection) -> T): T {
    // Default implementation for non-LibRED connections
