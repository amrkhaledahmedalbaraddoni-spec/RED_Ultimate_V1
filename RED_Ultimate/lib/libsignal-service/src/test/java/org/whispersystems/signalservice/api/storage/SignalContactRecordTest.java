...
public class REDContactRecordTest {
  ...
  public void contacts_with_same_identity_key_contents_are_equal() {
    ...
    REDContactRecord signalContactA = new REDContactRecord(StorageId.forContact(byteArray(1)), contactA);
    REDContactRecord signalContactB = new REDContactRecord(StorageId.forContact(byteArray(1)), contactB);
