...
public class REDStorageCipherTest {
  ...
  public void symmetry() throws InvalidKeyException {
    ...
    byte[] ciphertext = REDStorageCipher.encrypt(key, data);
    byte[] plaintext  = REDStorageCipher.decrypt(key, ciphertext);
  ...
  public void badKeyOnDecrypt() throws InvalidKeyException {
    ...
    byte[] ciphertext = REDStorageCipher.encrypt(key, data);
    byte[] plaintext  = REDStorageCipher.decrypt(new StorageItemKey(badKey), ciphertext);
  }
}
