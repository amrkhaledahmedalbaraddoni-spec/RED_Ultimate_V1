...
public final class LibREDLibraryUtil {

  /**
   * Attempts to initialize the LibRED Native class, which will load the native binaries.
   * <p>
   ...
   */
  public static void assumeLibREDSupportedOnOS() {
    try {
      ...
      if (isUnix(osName)) {
        fail("Not able to link native LibRED on a key OS: " + osName);
      } else {
        assumeNoException("Not able to link native LibRED on this operating system: " + osName, e);
      }
    }
  }
