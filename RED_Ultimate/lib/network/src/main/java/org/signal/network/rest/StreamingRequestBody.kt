 ...
 * memory. Suitable for uploading large files / blobs through [REDRestClient.request].
 *
 * Pair with a [org.whispersystems.signalservice.api.messages.REDServiceAttachment.ProgressListener]
