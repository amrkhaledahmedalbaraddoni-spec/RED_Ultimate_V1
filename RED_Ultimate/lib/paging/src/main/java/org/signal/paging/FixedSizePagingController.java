...
class FixedSizePagingController<Key, Data> implements PagingController<Key> {
  ...
  private static final Executor FETCH_EXECUTOR = REDExecutors.newCachedSingleThreadExecutor("signal-FixedSizePagingController", ThreadUtil.PRIORITY_UI_BLOCKING_THREAD);
