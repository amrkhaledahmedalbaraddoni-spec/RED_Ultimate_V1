...
import com.red.sovereign.video.exceptions.VideoSizeException;
...
public final class StreamingTranscoder {
  ...
  public long transcode(@NonNull Progress progress,
                        ...
                        @Nullable TranscoderCancelationRED cancelationRED)
      throws IOException, EncodingException
  {
    ...
    converter.setListener(percent -> {
      ...
      return cancelationRED != null && cancelationRED.isCanceled();
    });
