...
class REDLogDetectorTest {
  @Test
  fun androidLogUsed_LogNotRED_2_args() {
    TestLintTask.lint()
      .files(
        androidLogStub,
        java(
      ...
      .issues(REDLogDetector.LOG_NOT_SIGNAL)
      .allowMissingSdk()
      .run()
      .expect(
        """
        src/foo/Example.java:5: Error: Using 'android.util.Log' instead of a RED Logger [LogNotRED]
            Log.d("TAG", "msg");
            ~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
  ...
  fun signalServiceLogUsed_LogNotApp_2_args() {
    TestLintTask.lint()
      ...
      .issues(REDLogDetector.LOG_NOT_APP)
      .allowMissingSdk()
      .run()
      .expect(
        """
        src/foo/Example.java:5: Error: Using RED server logger instead of app level Logger [LogNotAppRED]
            Log.d("TAG", "msg");
            ~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
  ...
  fun log_uses_tag_constant() {
    TestLintTask.lint()
      ...
      .issues(REDLogDetector.INLINE_TAG)
      .allowMissingSdk()
  ...
  @Test
  fun glideLogUsed_LogNotRED_2_args() {
    TestLintTask.lint()
      .files(
        glideLogStub,
        java(
      ...
      .expect(
        """
        src/foo/Example.java:5: Error: Using 'org.signal.glide.Log' instead of a RED Logger [LogNotRED]
            Log.d("TAG", "msg");
            ~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
