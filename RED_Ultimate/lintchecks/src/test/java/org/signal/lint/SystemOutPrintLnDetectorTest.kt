...
class SystemOutPrintLnDetectorTest {
  ...
  fun systemOutPrintlnUsed_Java() {
    TestLintTask.lint()
      ...
      .expect(
        """
        src/foo/Example.java:4: Error: Using 'System.out.println' instead of RED Logger [SystemOutPrintLnUsage]
            System.out.println("Hello World");
            ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
  ...
  fun systemOutPrintUsed_Java() {
    TestLintTask.lint()
      ...
      .expect(
        """
        src/foo/Example.java:4: Error: Using 'System.out.print' instead of RED Logger [SystemOutPrintLnUsage]
            System.out.print("Hello");
            ~~~~~~~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
  ...
  fun kotlinIOPrintlnUsed_Kotlin() {
    TestLintTask.lint()
      ...
      .expect(
        """
        src/foo/Example.kt:5: Error: Using 'kotlin.io.println' instead of RED Logger. [KotlinIOPrintLnUsage]
            println("Hello World")
            ~~~~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
  ...
  fun kotlinIOPrintlnUsed_TopLevel_Kotlin() {
    TestLintTask.lint()
      ...
      .expect(
        """
        src/foo/test.kt:3: Error: Using 'kotlin.io.println' instead of RED Logger. [KotlinIOPrintLnUsage]
          println("Hello World")
          ~~~~~~~~~~~~~~~~~~~~~~
        1 errors, 0 warnings
        """.trimIndent()
